        ...
        <div className="contact-layout">
          ...
          <div className="contact-main-grid">
            ...
            >
              ...
              <form ref={formRef} onSubmit={handleSubmit} noValidate aria-describedby={submitSuccess ? "success-message" : undefined}>
                <motion.div
                  className="form-row"
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                ...
                >
                  ...
                  >
                    ...
                    <motion.input
                      ...
                      viewport={{ once: true }}
                      whileFocus={{ scale: 1.02, boxShadow: "0 0 0 3px rgba(255, 107, 0, 0.1)" }}
                      whileHover={{ y: -2 }}
                    />
                    {errors.name && (
                      <motion.div
                  ...
                  >
                    ...
                    <div className="custom-select-wrapper">
                      <motion.select
                        ...
                        onChange={handleChange}
                        onBlur={handleBlur}
                        className={`custom-select ${errors.service ? 'error' : ''}`}
                ...
                >
                  ...
                  <motion.textarea
                    ...
                    viewport={{ once: true }}
                    whileFocus={{ scale: 1.01, boxShadow: "0 0 0 3px rgba(255, 107, 0, 0.1)" }}
                    whileHover={{ y: -1 }}
                  />
                  {errors.message && (
                    <motion.div
                ...
                >
                  <motion.div
                    ...
                    animate={isSubmitting ? { opacity: [1, 0.7, 1] } : { opacity: 1 }}
            ...
            <div className="contact-info-map-wrapper">
              ...
              >
                <div className="social-links-container">
                  <h3 id="social-links-title" className="social-links-title">Follow Us</h3>
