...
`).find(a=>!a.trim().startsWith("#")&&a.trim()!=="")}async function Bb(t){try{const i=(await fetch(t,{method:"HEAD"})).headers.get("Content-Type");return Db.some(a=>i===a)}catch{return!1}}async function Wb(t){try{const e=await(await fetch(t)).text();let i=e;const a=Ub(e);if(a.length>0){const s=new URL(a[0],t).toString();i=await(await fetch(s)).text()}const r=Hb(i);return $b(r)}catch{return}}const Fn=new Lb,ni=new WeakSet;let ye;Mb(()=>{globalThis.chrome?.cast?.isAvailable&&(ye||(ye=cast.framework,gi().addEventListener(ye.CastContextEventType.CAST_STATE_CHANGED,t=>{Fn.forEach(e=>Gi.get(e).onCastStateChanged?.(t))}),gi().addEventListener(ye.CastContextEventType.SESSION_STATE_CHANGED,t=>{Fn.forEach(e=>Gi.get(e).onSessionStateChanged?.(t))}),Fn.forEach(t=>Gi.get(t).init?.())))});let Dc=0;class Fb extends EventTarget{#t;#s;#i;#a;#e="disconnected";#r=!1;#o=new Set;#c=new WeakMap;constructor(e){super(),this.#t=e,Fn.add(this),Gi.set(this,{init:()=>this.#d(),onCastStateChanged:()=>this.#l(),onSessionStateChanged:()=>this.#p(),getCastPlayer:()=>this.#n}),this.#d()}get#n(){if(ni.has(this.#t))return this.#i}get state(){return this.#e}async watchAvailability(e){if(this.#t.disableRemotePlayback)throw new qo("disableRemotePlayback attribute is present.");return this.#c.set(e,++Dc),this.#o.add(e),queueMicrotask(()=>e(this.#m())),Dc}async cancelWatchAvailability(e){if(this.#t.disableRemotePlayback)throw new qo("disableRemotePlayback attribute is present.");e?this.#o.delete(e):this.#o.clear()}async prompt(){if(this.#t.disableRemotePlayback)throw new qo("disableRemotePlayback attribute is present.");if(!globalThis.chrome?.cast?.isAvailable)throw new Cb("The RemotePlayback API is disabled on this platform.");const e=ni.has(this.#t);ni.add(this.#t),Cc(this.#t.castOptions),Object.entries(this.#a).forEach(([i,a])=>{this.#i.controller.addEventListener(i,a)});try{await gi().requestSession()}catch(i){if(e||ni.delete(this.#t),i==="cancel")return;throw new Error(i)}Gi.get(this.#t)?.loadOnPrompt?.()}#h(){ni.has(this.#t)&&(Object.entries(this.#a).forEach(([e,i])=>{this.#i.controller.removeEventListener(e,i)}),ni.delete(this.#t),this.#t.muted=this.#i.isMuted,this.#t.currentTime=this.#i.savedPlayerState.currentTime,this.#i.savedPlayerState.isPaused===!1&&this.#t.play())}#m(){const e=gi()?.getCastState();return e&&e!=="NO_DEVICES_AVAILABLE"}#l(){const e=gi().getCastState();if(ni.has(this.#t)&&e==="CONNECTING"&&(this.#e="connecting",this.dispatchEvent(new Event("connecting"))),!this.#r&&e?.includes("CONNECT")){this.#r=!0;for(let i of this.#o)i(!0)}else if(this.#r&&(!e||e==="NO_DEVICES_AVAILABLE")){this.#r=!1;for(let i of this.#o)i(!1)}}async#p(){const{SESSION_RESUMED:e}=ye.SessionState;if(gi().getSessionState()===e&&this.#t.castSrc===Bd()?.media.contentId){ni.add(this.#t),Object.entries(this.#a).forEach(([i,a])=>{this.#i.controller.addEventListener(i,a)});try{await Pb(new chrome.cast.media.GetStatusRequest)}catch{}this.#a[ye.RemotePlayerEventType.IS_PAUSED_CHANGED](),this.#a[ye.RemotePlayerEventType.PLAYER_STATE_CHANGED]()}}#d(){!ye||this.#s||(this.#s=!0,Cc(this.#t.castOptions),this.#t.textTracks.addEventListener("change",()=>this.#u()),this.#l(),this.#i=new ye.RemotePlayer,new ye.RemotePlayerController(this.#i),this.#a={[ye.RemotePlayerEventType.IS_CONNECTED_CHANGED]:({value:e})=>{e===!0?(this.#e="connected",this.dispatchEvent(new Event("connect"))):(this.#h(),this.#e="disconnected",this.dispatchEvent(new Event("disconnect")))},[ye.RemotePlayerEventType.DURATION_CHANGED]:()=>{this.#t.dispatchEvent(new Event("durationchange"))},[ye.RemotePlayerEventType.VOLUME_LEVEL_CHANGED]:()=>{this.#t.dispatchEvent(new Event("volumechange"))},[ye.RemotePlayerEventType.IS_MUTED_CHANGED]:()=>{this.#t.dispatchEvent(new Event("volumechange"))},[ye.RemotePlayerEventType.CURRENT_TIME_CHANGED]:()=>{this.#n?.isMediaLoaded&&this.#t.dispatchEvent(new Event("timeupdate"))},[ye.RemotePlayerEventType.VIDEO_INFO_CHANGED]:()=>{this.#t.dispatchEvent(new Event("resize"))},[ye.RemotePlayerEventType.IS_PAUSED_CHANGED]:()=>{this.#t.dispatchEvent(new Event(this.paused?"pause":"play"))},[ye.RemotePlayerEventType.PLAYER_STATE_CHANGED]:()=>{this.#n?.playerState!==chrome.cast.media.PlayerState.PAUSED&&this.#t.dispatchEvent(new Event({[chrome.cast.media.PlayerState.PLAYING]:"playing",[chrome.cast.media.PlayerState.BUFFERING]:"waiting",[chrome.cast.media.PlayerState.IDLE]:"emptied"}[this.#n?.playerState]))},[ye.RemotePlayerEventType.IS_MEDIA_LOADED_CHANGED]:async()=>{this.#n?.isMediaLoaded&&(await Promise.resolve(),this.#v())}})}#v(){this.#u()}async#u(){if(!this.#n)return;const i=(this.#i.mediaInfo?.tracks??[]).filter(({type:p})=>p===chrome.cast.media.TrackType.TEXT),a=[...this.#t.textTracks].filter(({kind:p})=>p==="subtitles"||p==="captions"),r=i.map(({language:p,name:h,trackId:c})=>{const{mode:v}=a.find(g=>g.language===p&&g.label===h)??{};return v?{mode:v,trackId:c}:!1}).filter(Boolean),s=r.filter(({mode:p})=>p!=="showing").map(({trackId:p})=>p),o=r.find(({mode:p})=>p==="showing"),l=Hd()?.getSessionObj().media[0]?.activeTrackIds??[];let d=l;if(l.length&&(d=d.filter(p=>!s.includes(p))),o?.trackId&&(d=[...d,o.trackId]),d=[...new Set(d)],!((p,h)=>p.length===h.length&&p.every(c=>h.includes(c)))(l,d))try{const p=new chrome.cast.media.EditTracksInfoRequest(d);await Nb(p)}catch{}}}const Vb=t=>class extends t{static observedAttributes=[...t.observedAttributes??[],"cast-src","cast-content-type","cast-stream-type","cast-receiver"];#t={paused:!1};#s=Nm();#i;#a;get remote(){return this.#a?this.#a:xb()?(this.disableRemotePlayback||Ob(),Gi.set(this,{loadOnPrompt:()=>this.#r()}),this.#a=new Fb(this)):super.remote}get#e(){return Gi.get(this.remote)?.getCastPlayer?.()}attributeChangedCallback(i,a,r){if(super.attributeChangedCallback(i,a,r),i==="cast-receiver"&&r){this.#s.receiverApplicationId=r;return}if(this.#e)switch(i){case"cast-stream-type":case"cast-src":this.load();break}}async#r(){this.#t.paused=super.paused,super.pause(),this.muted=super.muted;try{await this.load()}catch{}}async load(){if(!this.#e)return super.load();const i=new chrome.cast.media.MediaInfo(this.castSrc,this.castContentType);i.customData=this.castCustomData;const a=[...this.querySelectorAll("track")].filter(({kind:o,src:l})=>l&&(o==="subtitles"||o==="captions")),r=[];let n=0;if(a.length&&(i.tracks=a.map(o=>{const l=++n;r.length===0&&o.track.mode==="showing"&&r.push(l);const d=new chrome.cast.media.Track(l,chrome.cast.media.TrackType.TEXT);return d.trackContentId=o.src,d.trackContentType="text/vtt",d.subtype=o.kind==="captions"?chrome.cast.media.TextTrackType.CAPTIONS:chrome.cast.media.TextTrackType.SUBTITLES,d.name=o.label,d.language=o.srclang,d})),this.castStreamType==="live"?i.streamType=chrome.cast.media.StreamType.LIVE:i.streamType=chrome.cast.media.StreamType.BUFFERED,i.metadata=new chrome.cast.media.GenericMediaMetadata,i.metadata.title=this.title,i.metadata.images=[{url:this.poster}],Bb(this.castSrc)){const o=await Wb(this.castSrc);o?.includes("m4s")||o?.includes("mp4")?(i.hlsSegmentFormat=chrome.cast.media.HlsSegmentFormat.FMP4,i.hlsVideoSegmentFormat=chrome.cast.media.HlsVideoSegmentFormat.FMP4):o?.includes("ts")&&(i.hlsSegmentFormat=chrome.cast.media.HlsSegmentFormat.TS,i.hlsVideoSegmentFormat=chrome.cast.media.HlsVideoSegmentFormat.TS)}const s=new chrome.cast.media.LoadRequest(i);s.currentTime=super.currentTime??0,s.autoplay=!this.#t.paused,s.activeTrackIds=r,await Hd()?.loadMedia(s),this.dispatchEvent(new Event("volumechange"))}play(){if(this.#e){this.#e.isPaused&&this.#e.controller?.playOrPause();return}return super.play()}pause(){if(this.#e){this.#e.isPaused||this.#e.controller?.playOrPause();return}super.pause()}get castOptions(){return this.#s}get castReceiver(){return this.getAttribute("cast-receiver")??void 0}set castReceiver(i){this.castReceiver!=i&&this.setAttribute("cast-receiver",`${i}`)}get castSrc(){return this.getAttribute("cast-src")??this.querySelector("source")?.src??this.currentSrc}set castSrc(i){this.castSrc!=i&&this.setAttribute("cast-src",`${i}`)}get castContentType(){return this.getAttribute("cast-content-type")??void 0}set castContentType(i){this.setAttribute("cast-content-type",`${i}`)}get castStreamType(){return this.getAttribute("cast-stream-type")??this.streamType??void 0}set castStreamType(i){this.setAttribute("cast-stream-type",`${i}`)}get castCustomData(){return this.#i}set castCustomData(i){const a=typeof i;["object","undefined"].includes(a)&&(this.#i=i)}get readyState(){if(this.#e)switch(this.#e.playerState){case chrome.cast.media.PlayerState.IDLE:return 0;case chrome.cast.media.PlayerState.BUFFERING:return 2;default:return 3}return super.readyState}get paused(){return this.#e?this.#e.isPaused:super.paused}get muted(){return this.#e?this.#e?.isMuted:super.muted}set muted(i){if(this.#e){(i&&!this.#e.isMuted||!i&&this.#e.isMuted)&&this.#e.controller?.muteOrUnmute();return}super.muted=i}get volume(){return this.#e?this.#e?.volumeLevel??1:super.volume}set volume(i){if(this.#e){this.#e.volumeLevel=+i,this.#e.controller?.setVolumeLevel();return}super.volume=i}get duration(){return this.#e&&this.#e?.isMediaLoaded?this.#e?.duration??NaN:super.duration}get currentTime(){return this.#e&&this.#e?.isMediaLoaded?this.#e?.currentTime??0:super.currentTime}set currentTime(i){if(this.#e){this.#e.currentTime=i,this.#e.controller?.seek();return}super.currentTime=i}};var Pm=t=>{throw TypeError(t)},$m=(t,e,i)=>e.has(t)||Pm("Cannot "+i),Kb=(t,e,i)=>($m(t,e,"read from private field"),i?i.call(t):e.get(t)),qb=(t,e,i)=>e.has(t)?Pm("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,i),Yb=(t,e,i,a)=>($m(t,e,"write to private field"),e.set(t,i),i),Um=class{addEventListener(){}removeEventListener(){}dispatchEvent(e){return!0}};if(typeof DocumentFragment>"u"){class t extends Um{}globalThis.DocumentFragment=t}var Gb=class extends Um{},Qb={get(t){},define(t,e,i){},getName(t){return null},upgrade(t){},whenDefined(t){return Promise.resolve(Gb)}},Zb={customElements:Qb},jb=typeof window>"u"||typeof globalThis.customElements>"u",Yo=jb?Zb:globalThis,Vn,Lc=class extends Vb(ef(Rb)){constructor(){super(...arguments),qb(this,Vn)}get autoplay(){let t=this.getAttribute("autoplay");return t===null?!1:t===""?!0:t}set autoplay(t){let e=this.autoplay;t!==e&&(t?this.setAttribute("autoplay",typeof t=="string"?t:""):this.removeAttribute("autoplay"))}get muxCastCustomData(){return{mux:{playbackId:this.playbackId,minResolution:this.minResolution,maxResolution:this.maxResolution,renditionOrder:this.renditionOrder,customDomain:this.customDomain,tokens:{drm:this.drmToken},envKey:this.envKey,metadata:this.metadata,disableCookies:this.disableCookies,disableTracking:this.disableTracking,beaconCollectionDomain:this.beaconCollectionDomain,startTime:this.startTime,preferCmcd:this.preferCmcd}}}get castCustomData(){var t;return(t=Kb(this,Vn))!=null?t:this.muxCastCustomData}set castCustomData(t){Yb(this,Vn,t)}};Vn=new WeakMap;Yo.customElements.get("mux-video")||(Yo.customElements.define("mux-video",Lc),Yo.MuxVideoElement=Lc);const R={MEDIA_PLAY_REQUEST:"mediaplayrequest",MEDIA_PAUSE_REQUEST:"mediapauserequest",MEDIA_MUTE_REQUEST:"mediamuterequest",MEDIA_UNMUTE_REQUEST:"mediaunmuterequest",MEDIA_VOLUME_REQUEST:"mediavolumerequest",MEDIA_SEEK_REQUEST:"mediaseekrequest",MEDIA_AIRPLAY_REQUEST:"mediaairplayrequest",MEDIA_ENTER_FULLSCREEN_REQUEST:"mediaenterfullscreenrequest",MEDIA_EXIT_FULLSCREEN_REQUEST:"mediaexitfullscreenrequest",MEDIA_PREVIEW_REQUEST:"mediapreviewrequest",MEDIA_ENTER_PIP_REQUEST:"mediaenterpiprequest",MEDIA_EXIT_PIP_REQUEST:"mediaexitpiprequest",MEDIA_ENTER_CAST_REQUEST:"mediaentercastrequest",MEDIA_EXIT_CAST_REQUEST:"mediaexitcastrequest",MEDIA_SHOW_TEXT_TRACKS_REQUEST:"mediashowtexttracksrequest",MEDIA_HIDE_TEXT_TRACKS_REQUEST:"mediahidetexttracksrequest",MEDIA_SHOW_SUBTITLES_REQUEST:"mediashowsubtitlesrequest",MEDIA_DISABLE_SUBTITLES_REQUEST:"mediadisablesubtitlesrequest",MEDIA_TOGGLE_SUBTITLES_REQUEST:"mediatogglesubtitlesrequest",MEDIA_PLAYBACK_RATE_REQUEST:"mediaplaybackraterequest",MEDIA_RENDITION_REQUEST:"mediarenditionrequest",MEDIA_AUDIO_TRACK_REQUEST:"mediaaudiotrackrequest",MEDIA_SEEK_TO_LIVE_REQUEST:"mediaseektoliverequest",REGISTER_MEDIA_STATE_RECEIVER:"registermediastatereceiver",UNREGISTER_MEDIA_STATE_RECEIVER:"unregistermediastatereceiver"},q={MEDIA_CHROME_ATTRIBUTES:"mediachromeattributes",MEDIA_CONTROLLER:"mediacontroller"},Hm={MEDIA_AIRPLAY_UNAVAILABLE:"mediaAirplayUnavailable",MEDIA_AUDIO_TRACK_ENABLED:"mediaAudioTrackEnabled",MEDIA_AUDIO_TRACK_LIST:"mediaAudioTrackList",MEDIA_AUDIO_TRACK_UNAVAILABLE:"mediaAudioTrackUnavailable",MEDIA_BUFFERED:"mediaBuffered",MEDIA_CAST_UNAVAILABLE:"mediaCastUnavailable",MEDIA_CHAPTERS_CUES:"mediaChaptersCues",MEDIA_CURRENT_TIME:"mediaCurrentTime",MEDIA_DURATION:"mediaDuration",MEDIA_ENDED:"mediaEnded",MEDIA_ERROR:"mediaError",MEDIA_ERROR_CODE:"mediaErrorCode",MEDIA_ERROR_MESSAGE:"mediaErrorMessage",MEDIA_FULLSCREEN_UNAVAILABLE:"mediaFullscreenUnavailable",MEDIA_HAS_PLAYED:"mediaHasPlayed",MEDIA_HEIGHT:"mediaHeight",MEDIA_IS_AIRPLAYING:"mediaIsAirplaying",MEDIA_IS_CASTING:"mediaIsCasting",MEDIA_IS_FULLSCREEN:"mediaIsFullscreen",MEDIA_IS_PIP:"mediaIsPip",MEDIA_LOADING:"mediaLoading",MEDIA_MUTED:"mediaMuted",MEDIA_PAUSED:"mediaPaused",MEDIA_PIP_UNAVAILABLE:"mediaPipUnavailable",MEDIA_PLAYBACK_RATE:"mediaPlaybackRate",MEDIA_PREVIEW_CHAPTER:"mediaPreviewChapter",MEDIA_PREVIEW_COORDS:"mediaPreviewCoords",MEDIA_PREVIEW_IMAGE:"mediaPreviewImage",MEDIA_PREVIEW_TIME:"mediaPreviewTime",MEDIA_RENDITION_LIST:"mediaRenditionList",MEDIA_RENDITION_SELECTED:"mediaRenditionSelected",MEDIA_RENDITION_UNAVAILABLE:"mediaRenditionUnavailable",MEDIA_SEEKABLE:"mediaSeekable",MEDIA_STREAM_TYPE:"mediaStreamType",MEDIA_SUBTITLES_LIST:"mediaSubtitlesList",MEDIA_SUBTITLES_SHOWING:"mediaSubtitlesShowing",MEDIA_TARGET_LIVE_WINDOW:"mediaTargetLiveWindow",MEDIA_TIME_IS_LIVE:"mediaTimeIsLive",MEDIA_VOLUME:"mediaVolume",MEDIA_VOLUME_LEVEL:"mediaVolumeLevel",MEDIA_VOLUME_UNAVAILABLE:"mediaVolumeUnavailable",MEDIA_LANG:"mediaLang",MEDIA_WIDTH:"mediaWidth"},Bm=Object.entries(Hm),u=Bm.reduce((t,[e,i])=>(t[e]=i.toLowerCase(),t),{}),zb={USER_INACTIVE_CHANGE:"userinactivechange",BREAKPOINTS_CHANGE:"breakpointchange",BREAKPOINTS_COMPUTED:"breakpointscomputed"},ii=Bm.reduce((t,[e,i])=>(t[e]=i.toLowerCase(),t),{...zb});Object.entries(ii).reduce((t,[e,i])=>{const a=u[e];return a&&(t[i]=a),t},{userinactivechange:"userinactive"});const Xb=Object.entries(u).reduce((t,[e,i])=>{const a=ii[e];return a&&(t[i]=a),t},{userinactive:"userinactivechange"}),Ft={SUBTITLES:"subtitles",CAPTIONS:"captions",CHAPTERS:"chapters",METADATA:"metadata"},Na={DISABLED:"disabled",SHOWING:"showing"},Go={MOUSE:"mouse",PEN:"pen",TOUCH:"touch"},Ye={UNAVAILABLE:"unavailable",UNSUPPORTED:"unsupported"},jt={LIVE:"live",ON_DEMAND:"on-demand",UNKNOWN:"unknown"},Jb={FULLSCREEN:"fullscreen"};function eg(t){return t?.map(ig).join(" ")}function tg(t){return t?.split(/\s+/).map(ag)}function ig(t){if(t){const{id:e,width:i,height:a}=t;return[e,i,a].filter(r=>r!=null).join(":")}}function ag(t){if(t){const[e,i,a]=t.split(":");return{id:e,width:+i,height:+a}}}function rg(t){return t?.map(sg).join(" ")}function ng(t){return t?.split(/\s+/).map(og)}function sg(t){if(t){const{id:e,kind:i,language:a,label:r}=t;return[e,i,a,r].filter(n=>n!=null).join(":")}}function og(t){if(t){const[e,i,a,r]=t.split(":");return{id:e,kind:i,language:a,label:r}}}function lg(t){return t.replace(/[-_]([a-z])/g,(e,i)=>i.toUpperCase())}function Wd(t){return typeof t=="number"&&!Number.isNaN(t)&&Number.isFinite(t)}function Wm(t){return typeof t!="string"?!1:!isNaN(t)&&!isNaN(parseFloat(t))}const Fm=t=>new Promise(e=>setTimeout(e,t)),Mc=[{singular:"hour",plural:"hours"},{singular:"minute",plural:"minutes"},{singular:"second",plural:"seconds"}],dg=(t,e)=>{const i=t===1?Mc[e].singular:Mc[e].plural;return`${t} ${i}`},Ur=t=>{if(!Wd(t))return"";const e=Math.abs(t),i=e!==t,a=new Date(0,0,0,0,0,e,0);return`${[a.getHours(),a.getMinutes(),a.getSeconds()].map((o,l)=>o&&dg(o,l)).filter(o=>o).join(", ")}${i?" remaining":""}`};function Ti(t,e){let i=!1;t<0&&(i=!0,t=0-t),t=t<0?0:t;let a=Math.floor(t%60),r=Math.floor(t/60%60),n=Math.floor(t/3600);const s=Math.floor(e/60%60),o=Math.floor(e/3600);return(isNaN(t)||t===1/0)&&(n=r=a="0"),n=n>0||o>0?n+":":"",r=((n||s>=10)&&r<10?"0"+r:r)+":",a=a<10?"0"+a:a,(i?"-":"")+n+r+a}const ug={"Start airplay":"Start airplay","Stop airplay":"Stop airplay",Audio:"Audio",Captions:"Captions","Enable captions":"Enable captions","Disable captions":"Disable captions","Start casting":"Start casting","Stop casting":"Stop casting","Enter fullscreen mode":"Enter fullscreen mode","Exit fullscreen mode":"Exit fullscreen mode",Mute:"Mute",Unmute:"Unmute","Enter picture in picture mode":"Enter picture in picture mode","Exit picture in picture mode":"Exit picture in picture mode",Play:"Play",Pause:"Pause","Playback rate":"Playback rate","Playback rate {playbackRate}":"Playback rate {playbackRate}",Quality:"Quality","Seek backward":"Seek backward","Seek forward":"Seek forward",Settings:"Settings",Auto:"Auto","audio player":"audio player","video player":"video player",volume:"volume",seek:"seek","closed captions":"closed captions","current playback rate":"current playback rate","playback time":"playback time","media loading":"media loading",settings:"settings","audio tracks":"audio tracks",quality:"quality",play:"play",pause:"pause",mute:"mute",unmute:"unmute","chapter: {chapterName}":"chapter: {chapterName}",live:"live",Off:"Off","start airplay":"start airplay","stop airplay":"stop airplay","start casting":"start casting","stop casting":"stop casting","enter fullscreen mode":"enter fullscreen mode","exit fullscreen mode":"exit fullscreen mode","enter picture in picture mode":"enter picture in picture mode","exit picture in picture mode":"exit picture in picture mode","seek to live":"seek to live","playing live":"playing live","seek back {seekOffset} seconds":"seek back {seekOffset} seconds","seek forward {seekOffset} seconds":"seek forward {seekOffset} seconds","Network Error":"Network Error","Decode Error":"Decode Error","Source Not Supported":"Source Not Supported","Encryption Error":"Encryption Error","A network error caused the media download to fail.":"A network error caused the media download to fail.","A media error caused playback to be aborted. The media could be corrupt or your browser does not support this format.":"A media error caused playback to be aborted. The media could be corrupt or your browser does not support this format.","An unsupported error occurred. The server or network failed, or your browser does not support this format.":"An unsupported error occurred. The server or network failed, or your browser does not support this format.","The media is encrypted and there are no keys to decrypt it.":"The media is encrypted and there are no keys to decrypt it."};var xc;const Qo={en:ug};let gl=((xc=globalThis.navigator)==null?void 0:xc.language)||"en";const cg=t=>{gl=t},hg=t=>{var e,i,a;const[r]=gl.split("-");return((e=Qo[gl])==null?void 0:e[t])||((i=Qo[r])==null?void 0:i[t])||((a=Qo.en)==null?void 0:a[t])||t},C=(t,e={})=>hg(t).replace(/\{(\w+)\}/g,(i,a)=>a in e?String(e[a]):`{${a}}`);let Vm=class{addEventListener(){}removeEventListener(){}dispatchEvent(){return!0}};class Km extends Vm{}let Oc=class extends Km{constructor(){super(...arguments),this.role=null}};class mg{observe(){}unobserve(){}disconnect(){}}const qm={createElement:function(){return new Zr.HTMLElement},createElementNS:function(){return new Zr.HTMLElement},addEventListener(){},removeEventListener(){},dispatchEvent(t){return!1}},Zr={ResizeObserver:mg,document:qm,Node:Km,Element:Oc,HTMLElement:class extends Oc{constructor(){super(...arguments),this.innerHTML=""}get content(){return new Zr.DocumentFragment}},DocumentFragment:class extends Vm{},customElements:{get:function(){},define:function(){},whenDefined:function(){}},localStorage:{getItem(t){return null},setItem(t,e){},removeItem(t){}},CustomEvent:function(){},getComputedStyle:function(){},navigator:{languages:[],get userAgent(){return""}},matchMedia(t){return{matches:!1,media:t}},DOMParser:class{parseFromString(e,i){return{body:{textContent:e}}}}},Ym=typeof window>"u"||typeof window.customElements>"u",Gm=Object.keys(Zr).every(t=>t in globalThis),f=Ym&&!Gm?Zr:globalThis,Te=Ym&&!Gm?qm:globalThis.document,Nc=new WeakMap,Fd=t=>{let e=Nc.get(t);return e||Nc.set(t,e=new Set),e},Qm=new f.ResizeObserver(t=>{for(const e of t)for(const i of Fd(e.target))i(e)});function Va(t,e){Fd(t).add(e),Qm.observe(t)}function Ka(t,e){const i=Fd(t);i.delete(e),i.size||Qm.unobserve(t)}function Xe(t){const e={};for(const i of t)e[i.name]=i.value;return e}function Ue(t){var e;return(e=yl(t))!=null?e:ja(t,"media-controller")}function yl(t){var e;const{MEDIA_CONTROLLER:i}=q,a=t.getAttribute(i);if(a)return(e=yo(t))==null?void 0:e.getElementById(a)}const Zm=(t,e,i=".value")=>{const a=t.querySelector(i);a&&(a.textContent=e)},pg=(t,e)=>{const i=`slot[name="${e}"]`,a=t.shadowRoot.querySelector(i);return a?a.children:[]},jm=(t,e)=>pg(t,e)[0],ri=(t,e)=>!t||!e?!1:t?.contains(e)?!0:ri(t,e.getRootNode().host),ja=(t,e)=>{if(!t)return null;const i=t.closest(e);return i||ja(t.getRootNode().host,e)};function Vd(t=document){var e;const i=t?.activeElement;return i?(e=Vd(i.shadowRoot))!=null?e:i:null}function yo(t){var e;const i=(e=t?.getRootNode)==null?void 0:e.call(t);return i instanceof ShadowRoot||i instanceof Document?i:null}function zm(t,{depth:e=3,checkOpacity:i=!0,checkVisibilityCSS:a=!0}={}){if(t.checkVisibility)return t.checkVisibility({checkOpacity:i,checkVisibilityCSS:a});let r=t;for(;r&&e>0;){const n=getComputedStyle(r);if(i&&n.opacity==="0"||a&&n.visibility==="hidden"||n.display==="none")return!1;r=r.parentElement,e--}return!0}function vg(t,e,i,a){const r=a.x-i.x,n=a.y-i.y,s=r*r+n*n;if(s===0)return 0;const o=((t-i.x)*r+(e-i.y)*n)/s;return Math.max(0,Math.min(1,o))}function Ee(t,e){const i=fg(t,a=>a===e);return i||Xm(t,e)}function fg(t,e){var i,a;let r;for(r of(i=t.querySelectorAll("style:not([media])"))!=null?i:[]){let n;try{n=(a=r.sheet)==null?void 0:a.cssRules}catch{continue}for(const s of n??[])if(e(s.selectorText))return s}}function Xm(t,e){var i,a;const r=(i=t.querySelectorAll("style:not([media])"))!=null?i:[],n=r?.[r.length-1];return n?.sheet?(n?.sheet.insertRule(`${e}{}`,n.sheet.cssRules.length),(a=n.sheet.cssRules)==null?void 0:a[n.sheet.cssRules.length-1]):{style:{setProperty:()=>{},removeProperty:()=>"",getPropertyValue:()=>""}}}function ie(t,e,i=Number.NaN){const a=t.getAttribute(e);return a!=null?+a:i}function de(t,e,i){const a=+i;if(i==null||Number.isNaN(a)){t.hasAttribute(e)&&t.removeAttribute(e);return}ie(t,e,void 0)!==a&&t.setAttribute(e,`${a}`)}function W(t,e){return t.hasAttribute(e)}function F(t,e,i){if(i==null){t.hasAttribute(e)&&t.removeAttribute(e);return}W(t,e)!=i&&t.toggleAttribute(e,i)}function ae(t,e,i=null){var a;return(a=t.getAttribute(e))!=null?a:i}function re(t,e,i){if(i==null){t.hasAttribute(e)&&t.removeAttribute(e);return}const a=`${i}`;ae(t,e,void 0)!==a&&t.setAttribute(e,a)}var Jm=(t,e,i)=>{if(!e.has(t))throw TypeError("Cannot "+i)},si=(t,e,i)=>(Jm(t,e,"read from private field"),i?i.call(t):e.get(t)),Eg=(t,e,i)=>{if(e.has(t))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(t):e.set(t,i)},fn=(t,e,i,a)=>(Jm(t,e,"write to private field"),e.set(t,i),i),Pe;function _g(t){return`
  ...
  `}class To extends f.HTMLElement{constructor(){if(super(),Eg(this,Pe,void 0),!this.shadowRoot){this.attachShadow(this.constructor.shadowRootOptions);const e=Xe(this.attributes);this.shadowRoot.innerHTML=this.constructor.getTemplateHTML(e)}}static get observedAttributes(){return[q.MEDIA_CONTROLLER,u.MEDIA_PAUSED]}attributeChangedCallback(e,i,a){var r,n,s,o,l;e===q.MEDIA_CONTROLLER&&(i&&((n=(r=si(this,Pe))==null?void 0:r.unassociateElement)==null||n.call(r,this),fn(this,Pe,null)),a&&this.isConnected&&(fn(this,Pe,(s=this.getRootNode())==null?void 0:s.getElementById(a)),(l=(o=si(this,Pe))==null?void 0:o.associateElement)==null||l.call(o,this)))}connectedCallback(){var e,i,a,r;this.tabIndex=-1,this.setAttribute("aria-hidden","true"),fn(this,Pe,bg(this)),this.getAttribute(q.MEDIA_CONTROLLER)&&((i=(e=si(this,Pe))==null?void 0:e.associateElement)==null||i.call(e,this)),(a=si(this,Pe))==null||a.addEventListener("pointerdown",this),(r=si(this,Pe))==null||r.addEventListener("click",this)}disconnectedCallback(){var e,i,a,r;this.getAttribute(q.MEDIA_CONTROLLER)&&((i=(e=si(this,Pe))==null?void 0:e.unassociateElement)==null||i.call(e,this)),(a=si(this,Pe))==null||a.removeEventListener("pointerdown",this),(r=si(this,Pe))==null||r.removeEventListener("click",this),fn(this,Pe,null)}handleEvent(e){var i;const a=(i=e.composedPath())==null?void 0:i[0];if(["video","media-controller"].includes(a?.localName)){if(e.type==="pointerdown")this._pointerType=e.pointerType;else if(e.type==="click"){const{clientX:n,clientY:s}=e,{left:o,top:l,width:d,height:m}=this.getBoundingClientRect(),p=n-o,h=s-l;if(p<0||h<0||p>d||h>m||d===0&&m===0)return;const c=this._pointerType||"mouse";if(this._pointerType=void 0,c===Go.TOUCH){this.handleTap(e);return}else if(c===Go.MOUSE||c===Go.PEN){this.handleMouseClick(e);return}}}}get mediaPaused(){return W(this,u.MEDIA_PAUSED)}set mediaPaused(e){F(this,u.MEDIA_PAUSED,e)}handleTap(e){}handleMouseClick(e){const i=this.mediaPaused?R.MEDIA_PLAY_REQUEST:R.MEDIA_PAUSE_REQUEST;this.dispatchEvent(new f.CustomEvent(i,{composed:!0,bubbles:!0}))}}Pe=new WeakMap;To.shadowRootOptions={mode:"open"};To.getTemplateHTML=_g;function bg(t){var e;const i=t.getAttribute(q.MEDIA_CONTROLLER);return i?(e=t.getRootNode())==null?void 0:e.getElementById(i):ja(t,"media-controller")}f.customElements.get("media-gesture-receiver")||f.customElements.define("media-gesture-receiver",To);var Pc=To,Kd=(t,e,i)=>{if(!e.has(t))throw TypeError("Cannot "+i)},je=(t,e,i)=>(Kd(t,e,"read from private field"),i?i.call(t):e.get(t)),Ge=(t,e,i)=>{if(e.has(t))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(t):e.set(t,i)},Di=(t,e,i,a)=>(Kd(t,e,"write to private field"),e.set(t,i),i),st=(t,e,i)=>(Kd(t,e,"access private method"),i),Ys,ca,jr,Ca,Kn,Tl,ep,gr,qn,Al,tp,kl,ip,zr,Ao,ko,qd,qa,Xr;const M={AUDIO:"audio",AUTOHIDE:"autohide",BREAKPOINTS:"breakpoints",GESTURES_DISABLED:"gesturesdisabled",KEYBOARD_CONTROL:"keyboardcontrol",NO_AUTOHIDE:"noautohide",USER_INACTIVE:"userinactive",AUTOHIDE_OVER_CONTROLS:"autohideovercontrols"};function gg(t){return`
    <style>
...
`;function l0(t){return`
  ...
  `}function S0(t,e){return`
    <slot></slot>
  `}class ki extends f.HTMLElement{constructor(){if(super(),A0(this,Lt,void 0),!this.shadowRoot){this.attachShadow(this.constructor.shadowRootOptions);const e=Xe(this.attributes);this.shadowRoot.innerHTML=this.constructor.getTemplateHTML(e)}}static get observedAttributes(){return[q.MEDIA_CONTROLLER]}attributeChangedCallback(e,i,a){var r,n,s,o,l;e===q.MEDIA_CONTROLLER&&(i&&((n=(r=Tn(this,Lt))==null?void 0:r.unassociateElement)==null||n.call(r,this),An(this,Lt,null)),a&&this.isConnected&&(An(this,Lt,(s=this.getRootNode())==null?void 0:s.getElementById(a)),(l=(o=Tn(this,Lt))==null?void 0:o.associateElement)==null||l.call(o,this)))}connectedCallback(){var e,i,a;const{style:r}=Ee(this.shadowRoot,":host");r.setProperty("display",`var(--media-control-display, var(--${this.localName}-display, inline-flex))`);const n=this.getAttribute(q.MEDIA_CONTROLLER);n&&(An(this,Lt,(e=this.getRootNode())==null?void 0:e.getElementById(n)),(a=(i=Tn(this,Lt))==null?void 0:i.associateElement)==null||a.call(i,this))}disconnectedCallback(){var e,i;(i=(e=Tn(this,Lt))==null?void 0:e.unassociateElement)==null||i.call(e,this),An(this,Lt,null)}}Lt=new WeakMap;ki.shadowRootOptions={mode:"open"};ki.getTemplateHTML=k0;ki.getSlotTemplateHTML=S0;f.customElements.get("media-text-display")||f.customElements.define("media-text-display",ki);var Cp=(t,e,i)=>{if(!e.has(t))throw TypeError("Cannot "+i)},jc=(t,e,i)=>(Cp(t,e,"read from private field"),i?i.call(t):e.get(t)),w0=(t,e,i)=>{if(e.has(t))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(t):e.set(t,i)},I0=(t,e,i,a)=>(Cp(t,e,"write to private field"),e.set(t,i),i),Sr;function R0(t,e){return`
    <slot>${Ti(e.mediaDuration)}</slot>
  `}class Dp extends ki{constructor(){var e;super(),w0(this,Sr,void 0),I0(this,Sr,this.shadowRoot.querySelector("slot")),jc(this,Sr).textContent=Ti((e=this.mediaDuration)!=null?e:0)}static get observedAttributes(){return[...super.observedAttributes,u.MEDIA_DURATION]}attributeChangedCallback(e,i,a){e===u.MEDIA_DURATION&&(jc(this,Sr).textContent=Ti(+a)),super.attributeChangedCallback(e,i,a)}get mediaDuration(){return ie(this,u.MEDIA_DURATION)}set mediaDuration(e){de(this,u.MEDIA_DURATION,e)}}Sr=new WeakMap;Dp.getSlotTemplateHTML=R0;f.customElements.get("media-duration-display")||f.customElements.define("media-duration-display",Dp);const C0={2:C("Network Error"),3:C("Decode Error"),4:C("Source Not Supported"),5:C("Encryption Error")},D0={2:C("A network error caused the media download to fail."),3:C("A media error caused playback to be aborted. The media could be corrupt or your browser does not support this format."),4:C("An unsupported error occurred. The server or network failed, or your browser does not support this format."),5:C("The media is encrypted and there are no keys to decrypt it.")},Lp=t=>{var e,i;return t.code===1?null:{title:(e=C0[t.code])!=null?e:`Error ${t.code}`,message:(i=D0[t.code])!=null?i:t.message}};var Mp=(t,e,i)=>{if(!e.has(t))throw TypeError("Cannot "+i)},L0=(t,e,i)=>(Mp(t,e,"read from private field"),i?i.call(t):e.get(t)),M0=(t,e,i)=>{if(e.has(t))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(t):e.set(t,i)},x0=(t,e,i,a)=>(Mp(t,e,"write to private field"),e.set(t,i),i),rs;function O0(t){return`
    <style>
      :host {
  ...
  `}function N0(t){return t.code&&Lp(t)!==null}function xp(t){var e;const{title:i,message:a}=(e=Lp(t))!=null?e:{};let r="";return i&&(r+=`<slot name="error-${t.code}-title"><h3>${i}</h3></slot>`),a&&(r+=`<slot name="error-${t.code}-message"><p>${a}</p></slot>`),r}const zc=[u.MEDIA_ERROR_CODE,u.MEDIA_ERROR_MESSAGE];class Do extends hn{constructor(){super(...arguments),M0(this,rs,null)}static get observedAttributes(){return[...super.observedAttributes,...zc]}formatErrorMessage(e){return this.constructor.formatErrorMessage(e)}attributeChangedCallback(e,i,a){var r;if(super.attributeChangedCallback(e,i,a),!zc.includes(e))return;const n=(r=this.mediaError)!=null?r:{code:this.mediaErrorCode,message:this.mediaErrorMessage};this.open=N0(n),this.open&&(this.shadowRoot.querySelector("slot").name=`error-${this.mediaErrorCode}`,this.shadowRoot.querySelector("#content").innerHTML=this.formatErrorMessage(n))}get mediaError(){return L0(this,rs)}set mediaError(e){x0(this,rs,e)}get mediaErrorCode(){return ie(this,"mediaerrorcode")}set mediaErrorCode(e){de(this,"mediaerrorcode",e)}get mediaErrorMessage(){return ae(this,"mediaerrormessage")}set mediaErrorMessage(e){re(this,"mediaerrormessage",e)}}rs=new WeakMap;Do.getSlotTemplateHTML=O0;Do.formatErrorMessage=xp;f.customElements.get("media-error-dialog")||f.customElements.define("media-error-dialog",Do);var Op=Do,Np=(t,e,i)=>{if(!e.has(t))throw TypeError("Cannot "+i)},P0=(t,e,i)=>(Np(t,e,"read from private field"),e.get(t)),$0=(t,e,i)=>{if(e.has(t))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(t):e.set(t,i)},U0=(t,e,i,a)=>(Np(t,e,"write to private field"),e.set(t,i),i),ns;const H0=`<svg aria-hidden="true" viewBox="0 0 26 24">
  <path d="M16 3v2.5h3.5V9H22V3h-6ZM4 9h2.5V5.5H10V3H4v6Zm15.5 9.5H16V21h6v-6h-2.5v3.5ZM6.5 15H4v6h6v-2.5H6.5V15Z"/>
</svg>`,B0=`<svg aria-hidden="true" viewBox="0 0 26 24">
  <path d="M18.5 6.5V3H16v6h6V6.5h-3.5ZM16 21h2.5v-3.5H22V15h-6v6ZM4 17.5h3.5V21H10v-6H4v2.5Zm3.5-11H4V9h6V3H7.5v3.5Z"/>
</svg>`;function W0(t){return`
    <style>
...
`;function Q0(t){return`
  ...
  `}const rh=t=>{const e=t.mediaIsPip?C("exit picture in picture mode"):C("enter picture in picture mode");t.setAttribute("aria-label",e)};class du extends De{static get observedAttributes(){return[...super.observedAttributes,u.MEDIA_IS_PIP,u.MEDIA_PIP_UNAVAILABLE]}connectedCallback(){super.connectedCallback(),rh(this)}attributeChangedCallback(e,i,a){super.attributeChangedCallback(e,i,a),e===u.MEDIA_IS_PIP&&rh(this)}get mediaPipUnavailable(){return ae(this,u.MEDIA_PIP_UNAVAILABLE)}set mediaPipUnavailable(e){re(this,u.MEDIA_PIP_UNAVAILABLE,e)}get mediaIsPip(){return W(this,u.MEDIA_IS_PIP)}set mediaIsPip(e){F(this,u.MEDIA_IS_PIP,e)}handleClick(){const e=this.mediaIsPip?R.MEDIA_EXIT_PIP_REQUEST:R.MEDIA_ENTER_PIP_REQUEST;this.dispatchEvent(new f.CustomEvent(e,{composed:!0,bubbles:!0}))}}du.getSlotTemplateHTML=J0;du.getTooltipContentHTML=e1;f.customElements.get("media-pip-button")||f.customElements.define("media-pip-button",du);var t1=(t,e,i)=>{if(!e.has(t))throw TypeError("Cannot "+i)},sa=(t,e,i)=>(t1(t,e,"read from private field"),i?i.call(t):e.get(t)),i1=(t,e,i)=>{if(e.has(t))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(t):e.set(t,i)},hi;const Zo={RATES:"rates"},Hp=[1,1.2,1.5,1.7,2],La=1;function a1(t){return`
    <style>
      :host {
        min-width: 5ch;
  ...
  <path d="M6 20h4V4H6v16Zm8-16v16h4V4h-4Z"/>
    ...
    <slot name="icon">
      <slot name="play">${n1}</slot>
      <slot name="pause">${s1}</slot>
    </slot>
  `}function l1(){return`
    <slot name="tooltip-play">${C("Play")}</slot>
    <slot name="tooltip-pause">${C("Pause")}</slot>
  `}const nh=t=>{const e=t.mediaPaused?C("play"):C("pause");t.setAttribute("aria-label",e)};class cu extends De{static get observedAttributes(){return[...super.observedAttributes,u.MEDIA_PAUSED,u.MEDIA_ENDED]}connectedCallback(){super.connectedCallback(),nh(this)}attributeChangedCallback(e,i,a){super.attributeChangedCallback(e,i,a),(e===u.MEDIA_PAUSED||e===u.MEDIA_LANG)&&nh(this)}get mediaPaused(){return W(this,u.MEDIA_PAUSED)}set mediaPaused(e){F(this,u.MEDIA_PAUSED,e)}handleClick(){const e=this.mediaPaused?R.MEDIA_PLAY_REQUEST:R.MEDIA_PAUSE_REQUEST;this.dispatchEvent(new f.CustomEvent(e,{composed:!0,bubbles:!0}))}}cu.getSlotTemplateHTML=o1;cu.getTooltipContentHTML=l1;f.customElements.get("media-play-button")||f.customElements.define("media-play-button",cu);const Tt={PLACEHOLDER_SRC:"placeholdersrc",SRC:"src"};function d1(t){return`
    <style>
      :host {
        pointer-events: none;
  ...
  `}const u1=t=>{t.style.removeProperty("background-image")},c1=(t,e)=>{t.style["background-image"]=`url('${e}')`};class hu extends f.HTMLElement{static get observedAttributes(){return[Tt.PLACEHOLDER_SRC,Tt.SRC]}constructor(){if(super(),!this.shadowRoot){this.attachShadow(this.constructor.shadowRootOptions);const e=Xe(this.attributes);this.shadowRoot.innerHTML=this.constructor.getTemplateHTML(e)}this.image=this.shadowRoot.querySelector("#image")}attributeChangedCallback(e,i,a){e===Tt.SRC&&(a==null?this.image.removeAttribute(Tt.SRC):this.image.setAttribute(Tt.SRC,a)),e===Tt.PLACEHOLDER_SRC&&(a==null?u1(this.image):c1(this.image,a))}get placeholderSrc(){return ae(this,Tt.PLACEHOLDER_SRC)}set placeholderSrc(e){re(this,Tt.SRC,e)}get src(){return ae(this,Tt.SRC)}set src(e){re(this,Tt.SRC,e)}}hu.shadowRootOptions={mode:"open"};hu.getTemplateHTML=d1;f.customElements.get("media-poster-image")||f.customElements.define("media-poster-image",hu);var Bp=(t,e,i)=>{if(!e.has(t))throw TypeError("Cannot "+i)},h1=(t,e,i)=>(Bp(t,e,"read from private field"),i?i.call(t):e.get(t)),m1=(t,e,i)=>{if(e.has(t))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(t):e.set(t,i)},p1=(t,e,i,a)=>(Bp(t,e,"write to private field"),e.set(t,i),i),ls;class v1 extends ki{constructor(){super(),m1(this,ls,void 0),p1(this,ls,this.shadowRoot.querySelector("slot"))}static get observedAttributes(){return[...super.observedAttributes,u.MEDIA_PREVIEW_CHAPTER,u.MEDIA_LANG]}attributeChangedCallback(e,i,a){if(super.attributeChangedCallback(e,i,a),(e===u.MEDIA_PREVIEW_CHAPTER||e===u.MEDIA_LANG)&&a!==i&&a!=null)if(h1(this,ls).textContent=a,a!==""){const r=C("chapter: {chapterName}",{chapterName:a});this.setAttribute("aria-valuetext",r)}else this.removeAttribute("aria-valuetext")}get mediaPreviewChapter(){return ae(this,u.MEDIA_PREVIEW_CHAPTER)}set mediaPreviewChapter(e){re(this,u.MEDIA_PREVIEW_CHAPTER,e)}}ls=new WeakMap;f.customElements.get("media-preview-chapter-display")||f.customElements.define("media-preview-chapter-display",v1);var Wp=(t,e,i)=>{if(!e.has(t))throw TypeError("Cannot "+i)},Sn=(t,e,i)=>(Wp(t,e,"read from private field"),i?i.call(t):e.get(t)),f1=(t,e,i)=>{if(e.has(t))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(t):e.set(t,i)},wn=(t,e,i,a)=>(Wp(t,e,"write to private field"),e.set(t,i),i),xt;function E1(t){return`
    <style>
      :host {
        box-sizing: border-box;
  ...
  `}class Lo extends f.HTMLElement{constructor(){if(super(),f1(this,xt,void 0),!this.shadowRoot){this.attachShadow(this.constructor.shadowRootOptions);const e=Xe(this.attributes);this.shadowRoot.innerHTML=this.constructor.getTemplateHTML(e)}}static get observedAttributes(){return[q.MEDIA_CONTROLLER,u.MEDIA_PREVIEW_IMAGE,u.MEDIA_PREVIEW_COORDS]}connectedCallback(){var e,i,a;const r=this.getAttribute(q.MEDIA_CONTROLLER);r&&(wn(this,xt,(e=this.getRootNode())==null?void 0:e.getElementById(r)),(a=(i=Sn(this,xt))==null?void 0:i.associateElement)==null||a.call(i,this))}disconnectedCallback(){var e,i;(i=(e=Sn(this,xt))==null?void 0:e.unassociateElement)==null||i.call(e,this),wn(this,xt,null)}attributeChangedCallback(e,i,a){var r,n,s,o,l;[u.MEDIA_PREVIEW_IMAGE,u.MEDIA_PREVIEW_COORDS].includes(e)&&this.update(),e===q.MEDIA_CONTROLLER&&(i&&((n=(r=Sn(this,xt))==null?void 0:r.unassociateElement)==null||n.call(r,this),wn(this,xt,null)),a&&this.isConnected&&(wn(this,xt,(s=this.getRootNode())==null?void 0:s.getElementById(a)),(l=(o=Sn(this,xt))==null?void 0:o.associateElement)==null||l.call(o,this)))}get mediaPreviewImage(){return ae(this,u.MEDIA_PREVIEW_IMAGE)}set mediaPreviewImage(e){re(this,u.MEDIA_PREVIEW_IMAGE,e)}get mediaPreviewCoords(){const e=this.getAttribute(u.MEDIA_PREVIEW_COORDS);if(e)return e.split(/\s+/).map(i=>+i)}set mediaPreviewCoords(e){if(!e){this.removeAttribute(u.MEDIA_PREVIEW_COORDS);return}this.setAttribute(u.MEDIA_PREVIEW_COORDS,e.join(" "))}update(){const e=this.mediaPreviewCoords,i=this.mediaPreviewImage;if(!(e&&i))return;const[a,r,n,s]=e,o=i.split("#")[0],l=getComputedStyle(this),{maxWidth:d,maxHeight:m,minWidth:p,minHeight:h}=l,c=Math.min(parseInt(d)/n,parseInt(m)/s),v=Math.max(parseInt(p)/n,parseInt(h)/s),g=c<1,_=g?c:v>1?v:1,{style:y}=Ee(this.shadowRoot,":host"),T=Ee(this.shadowRoot,"img").style,E=this.shadowRoot.querySelector("img"),k=g?"min":"max";y.setProperty(`${k}-width`,"initial","important"),y.setProperty(`${k}-height`,"initial","important"),y.width=`${n*_}px`,y.height=`${s*_}px`;const D=()=>{T.width=`${this.imgWidth*_}px`,T.height=`${this.imgHeight*_}px`,T.display="block"};E.src!==o&&(E.onload=()=>{this.imgWidth=E.naturalWidth,this.imgHeight=E.naturalHeight,D()},E.src=o,D()),D(),T.transform=`translate(-${a*_}px, -${r*_}px)`}}xt=new WeakMap;Lo.shadowRootOptions={mode:"open"};Lo.getTemplateHTML=E1;f.customElements.get("media-preview-thumbnail")||f.customElements.define("media-preview-thumbnail",Lo);var sh=Lo,Fp=(t,e,i)=>{if(!e.has(t))throw TypeError("Cannot "+i)},oh=(t,e,i)=>(Fp(t,e,"read from private field"),i?i.call(t):e.get(t)),_1=(t,e,i)=>{if(e.has(t))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(t):e.set(t,i)},b1=(t,e,i,a)=>(Fp(t,e,"write to private field"),e.set(t,i),i),wr;class g1 extends ki{constructor(){super(),_1(this,wr,void 0),b1(this,wr,this.shadowRoot.querySelector("slot")),oh(this,wr).textContent=Ti(0)}static get observedAttributes(){return[...super.observedAttributes,u.MEDIA_PREVIEW_TIME]}attributeChangedCallback(e,i,a){super.attributeChangedCallback(e,i,a),e===u.MEDIA_PREVIEW_TIME&&a!=null&&(oh(this,wr).textContent=Ti(parseFloat(a)))}get mediaPreviewTime(){return ie(this,u.MEDIA_PREVIEW_TIME)}set mediaPreviewTime(e){de(this,u.MEDIA_PREVIEW_TIME,e)}}wr=new WeakMap;f.customElements.get("media-preview-time-display")||f.customElements.define("media-preview-time-display",g1);const oa={SEEK_OFFSET:"seekoffset"},jo=30,y1=t=>`
  ...
  </svg>`;function T1(t,e){return`
    <slot name="icon">${y1(e.seekOffset)}</slot>
  `}function A1(){return C("Seek backward")}const k1=0;class mu extends De{static get observedAttributes(){return[...super.observedAttributes,u.MEDIA_CURRENT_TIME,oa.SEEK_OFFSET]}connectedCallback(){super.connectedCallback(),this.seekOffset=ie(this,oa.SEEK_OFFSET,jo)}attributeChangedCallback(e,i,a){super.attributeChangedCallback(e,i,a),e===oa.SEEK_OFFSET&&(this.seekOffset=ie(this,oa.SEEK_OFFSET,jo))}get seekOffset(){return ie(this,oa.SEEK_OFFSET,jo)}set seekOffset(e){de(this,oa.SEEK_OFFSET,e),this.setAttribute("aria-label",C("seek back {seekOffset} seconds",{seekOffset:this.seekOffset})),Zm(jm(this,"icon"),this.seekOffset)}get mediaCurrentTime(){return ie(this,u.MEDIA_CURRENT_TIME,k1)}set mediaCurrentTime(e){de(this,u.MEDIA_CURRENT_TIME,e)}handleClick(){const e=Math.max(this.mediaCurrentTime-this.seekOffset,0),i=new f.CustomEvent(R.MEDIA_SEEK_REQUEST,{composed:!0,bubbles:!0,detail:e});this.dispatchEvent(i)}}mu.getSlotTemplateHTML=T1;mu.getTooltipContentHTML=A1;f.customElements.get("media-seek-backward-button")||f.customElements.define("media-seek-backward-button",mu);const la={SEEK_OFFSET:"seekoffset"},zo=30,S1=t=>`
  <svg aria-hidden="true" viewBox="0 0 20 24">
    <defs>
      <style>.text{font-size:8px;font-family:Arial-BoldMT, Arial;font-weight:700;}</style>
    </defs>
    ...
    <slot name="icon">${S1(e.seekOffset)}</slot>
  `}function I1(){return C("Seek forward")}const R1=0;class pu extends De{static get observedAttributes(){return[...super.observedAttributes,u.MEDIA_CURRENT_TIME,la.SEEK_OFFSET]}connectedCallback(){super.connectedCallback(),this.seekOffset=ie(this,la.SEEK_OFFSET,zo)}attributeChangedCallback(e,i,a){super.attributeChangedCallback(e,i,a),e===la.SEEK_OFFSET&&(this.seekOffset=ie(this,la.SEEK_OFFSET,zo))}get seekOffset(){return ie(this,la.SEEK_OFFSET,zo)}set seekOffset(e){de(this,la.SEEK_OFFSET,e),this.setAttribute("aria-label",C("seek forward {seekOffset} seconds",{seekOffset:this.seekOffset})),Zm(jm(this,"icon"),this.seekOffset)}get mediaCurrentTime(){return ie(this,u.MEDIA_CURRENT_TIME,R1)}set mediaCurrentTime(e){de(this,u.MEDIA_CURRENT_TIME,e)}handleClick(){const e=this.mediaCurrentTime+this.seekOffset,i=new f.CustomEvent(R.MEDIA_SEEK_REQUEST,{composed:!0,bubbles:!0,detail:e});this.dispatchEvent(i)}}pu.getSlotTemplateHTML=w1;pu.getTooltipContentHTML=I1;f.customElements.get("media-seek-forward-button")||f.customElements.define("media-seek-forward-button",pu);var Vp=(t,e,i)=>{if(!e.has(t))throw TypeError("Cannot "+i)},Xo=(t,e,i)=>(Vp(t,e,"read from private field"),i?i.call(t):e.get(t)),C1=(t,e,i)=>{if(e.has(t))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(t):e.set(t,i)},D1=(t,e,i,a)=>(Vp(t,e,"write to private field"),e.set(t,i),i),va;const Mi={REMAINING:"remaining",SHOW_DURATION:"showduration",NO_TOGGLE:"notoggle"},lh=[...Object.values(Mi),u.MEDIA_CURRENT_TIME,u.MEDIA_DURATION,u.MEDIA_SEEKABLE],dh=["Enter"," "],L1="&nbsp;/&nbsp;",Fl=(t,{timesSep:e=L1}={})=>{var i,a;const r=(i=t.mediaCurrentTime)!=null?i:0,[,n]=(a=t.mediaSeekable)!=null?a:[];let s=0;Number.isFinite(t.mediaDuration)?s=t.mediaDuration:Number.isFinite(n)&&(s=n);const o=t.remaining?Ti(0-(s-r)):Ti(r);return t.showDuration?`${o}${e}${Ti(s)}`:o},M1="video not loaded, unknown time.",x1=t=>{var e;const i=t.mediaCurrentTime,[,a]=(e=t.mediaSeekable)!=null?e:[];let r=null;if(Number.isFinite(t.mediaDuration)?r=t.mediaDuration:Number.isFinite(a)&&(r=a),i==null||r===null){t.setAttribute("aria-valuetext",M1);return}const n=t.remaining?Ur(0-(r-i)):Ur(i);if(!t.showDuration){t.setAttribute("aria-valuetext",n);return}const s=Ur(r),o=`${n} of ${s}`;t.setAttribute("aria-valuetext",o)};function O1(t,e){return`
    <slot>${Fl(e)}</slot>
  `}class Kp extends ki{constructor(){super(),C1(this,va,void 0),D1(this,va,this.shadowRoot.querySelector("slot")),Xo(this,va).innerHTML=`${Fl(this)}`}static get observedAttributes(){return[...super.observedAttributes,...lh,"disabled"]}connectedCallback(){const{style:e}=Ee(this.shadowRoot,":host(:hover:not([notoggle]))");e.setProperty("cursor","var(--media-cursor, pointer)"),e.setProperty("background","var(--media-control-hover-background, rgba(50 50 70 / .7))"),this.hasAttribute("disabled")||this.enable(),this.setAttribute("role","progressbar"),this.setAttribute("aria-label",C("playback time"));const i=a=>{const{key:r}=a;if(!dh.includes(r)){this.removeEventListener("keyup",i);return}this.toggleTimeDisplay()};this.addEventListener("keydown",a=>{const{metaKey:r,altKey:n,key:s}=a;if(r||n||!dh.includes(s)){this.removeEventListener("keyup",i);return}this.addEventListener("keyup",i)}),this.addEventListener("click",this.toggleTimeDisplay),super.connectedCallback()}toggleTimeDisplay(){this.noToggle||(this.hasAttribute("remaining")?this.removeAttribute("remaining"):this.setAttribute("remaining",""))}disconnectedCallback(){this.disable(),super.disconnectedCallback()}attributeChangedCallback(e,i,a){lh.includes(e)?this.update():e==="disabled"&&a!==i&&(a==null?this.enable():this.disable()),super.attributeChangedCallback(e,i,a)}enable(){this.tabIndex=0}disable(){this.tabIndex=-1}get remaining(){return W(this,Mi.REMAINING)}set remaining(e){F(this,Mi.REMAINING,e)}get showDuration(){return W(this,Mi.SHOW_DURATION)}set showDuration(e){F(this,Mi.SHOW_DURATION,e)}get noToggle(){return W(this,Mi.NO_TOGGLE)}set noToggle(e){F(this,Mi.NO_TOGGLE,e)}get mediaDuration(){return ie(this,u.MEDIA_DURATION)}set mediaDuration(e){de(this,u.MEDIA_DURATION,e)}get mediaCurrentTime(){return ie(this,u.MEDIA_CURRENT_TIME)}set mediaCurrentTime(e){de(this,u.MEDIA_CURRENT_TIME,e)}get mediaSeekable(){const e=this.getAttribute(u.MEDIA_SEEKABLE);if(e)return e.split(":").map(i=>+i)}set mediaSeekable(e){if(e==null){this.removeAttribute(u.MEDIA_SEEKABLE);return}this.setAttribute(u.MEDIA_SEEKABLE,e.join(":"))}update(){const e=Fl(this);x1(this),e!==Xo(this,va).innerHTML&&(Xo(this,va).innerHTML=e)}}va=new WeakMap;Kp.getSlotTemplateHTML=O1;f.customElements.get("media-time-display")||f.customElements.define("media-time-display",Kp);var qp=(t,e,i)=>{if(!e.has(t))throw TypeError("Cannot "+i)},Se=(t,e,i)=>(qp(t,e,"read from private field"),e.get(t)),At=(t,e,i)=>{if(e.has(t))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(t):e.set(t,i)},Qe=(t,e,i,a)=>(qp(t,e,"write to private field"),e.set(t,i),i),N1=(t,e,i,a)=>({set _(r){Qe(t,e,r)},get _(){return Se(t,e)}}),fa,ds,Ea,Ir,us,cs,hs,_a,xi,ms;class P1{constructor(e,i,a){At(this,fa,void 0),At(this,ds,void 0),At(this,Ea,void 0),At(this,Ir,void 0),At(this,us,void 0),At(this,cs,void 0),At(this,hs,void 0),At(this,_a,void 0),At(this,xi,0),At(this,ms,(r=performance.now())=>{Qe(this,xi,requestAnimationFrame(Se(this,ms))),Qe(this,Ir,performance.now()-Se(this,Ea));const n=1e3/this.fps;if(Se(this,Ir)>n){Qe(this,Ea,r-Se(this,Ir)%n);const s=1e3/((r-Se(this,ds))/++N1(this,us)._),o=(r-Se(this,cs))/1e3/this.duration;let l=Se(this,hs)+o*this.playbackRate;l-Se(this,fa).valueAsNumber>0?Qe(this,_a,this.playbackRate/this.duration/s):(Qe(this,_a,.995*Se(this,_a)),l=Se(this,fa).valueAsNumber+Se(this,_a)),this.callback(l)}}),Qe(this,fa,e),this.callback=i,this.fps=a}start(){Se(this,xi)===0&&(Qe(this,Ea,performance.now()),Qe(this,ds,Se(this,Ea)),Qe(this,us,0),Se(this,ms).call(this))}stop(){Se(this,xi)!==0&&(cancelAnimationFrame(Se(this,xi)),Qe(this,xi,0))}update({start:e,duration:i,playbackRate:a}){const r=e-Se(this,fa).valueAsNumber,n=Math.abs(i-this.duration);(r>0||r<-.03||n>=.5)&&this.callback(e),Qe(this,hs,e),Qe(this,cs,performance.now()),this.duration=i,this.playbackRate=a}}fa=new WeakMap;ds=new WeakMap;Ea=new WeakMap;Ir=new WeakMap;us=new WeakMap;cs=new WeakMap;hs=new WeakMap;_a=new WeakMap;xi=new WeakMap;ms=new WeakMap;var vu=(t,e,i)=>{if(!e.has(t))throw TypeError("Cannot "+i)},ce=(t,e,i)=>(vu(t,e,"read from private field"),i?i.call(t):e.get(t)),ge=(t,e,i)=>{if(e.has(t))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(t):e.set(t,i)},tt=(t,e,i,a)=>(vu(t,e,"write to private field"),e.set(t,i),i),xe=(t,e,i)=>(vu(t,e,"access private method"),i),ba,Zi,Js,Wr,eo,ps,an,rn,ga,ya,Ta,Rr,fu,Yp,Vl,to,Eu,io,_u,ao,bu,Kl,Gp,nn,ro,ql,Qp;const $1="video not loaded, unknown time.",U1=t=>{const e=t.range,i=Ur(+Zp(t)),a=Ur(+t.mediaSeekableEnd),r=i&&a?`${i} of ${a}`:$1;e.setAttribute("aria-valuetext",r)};function H1(t){return`
  ...
  `}const In=(t,e=t.mediaCurrentTime)=>{const i=Number.isFinite(t.mediaSeekableStart)?t.mediaSeekableStart:0,a=Number.isFinite(t.mediaDuration)?t.mediaDuration:t.mediaSeekableEnd;if(Number.isNaN(a))return 0;const r=(e-i)/(a-i);return Math.max(0,Math.min(r,1))},Zp=(t,e=t.range.valueAsNumber)=>{const i=Number.isFinite(t.mediaSeekableStart)?t.mediaSeekableStart:0,a=Number.isFinite(t.mediaDuration)?t.mediaDuration:t.mediaSeekableEnd;return Number.isNaN(a)?0:e*(a-i)+i};class gu extends za{constructor(){super(),ge(this,Ta),ge(this,fu),ge(this,to),ge(this,io),ge(this,ao),ge(this,Kl),ge(this,nn),ge(this,ql),ge(this,ba,void 0),ge(this,Zi,void 0),ge(this,Js,void 0),ge(this,Wr,void 0),ge(this,eo,void 0),ge(this,ps,void 0),ge(this,an,void 0),ge(this,rn,void 0),ge(this,ga,void 0),ge(this,ya,void 0),ge(this,Vl,a=>{this.dragging||(Wd(a)&&(this.range.valueAsNumber=a),ce(this,ya)||this.updateBar())}),this.shadowRoot.querySelector("#track").insertAdjacentHTML("afterbegin",'<div id="buffered" part="buffered"></div>'),tt(this,Js,this.shadowRoot.querySelectorAll('[part~="box"]')),tt(this,eo,this.shadowRoot.querySelector('[part~="preview-box"]')),tt(this,ps,this.shadowRoot.querySelector('[part~="current-box"]'));const i=getComputedStyle(this);tt(this,an,parseInt(i.getPropertyValue("--media-box-padding-left"))),tt(this,rn,parseInt(i.getPropertyValue("--media-box-padding-right"))),tt(this,Zi,new P1(this.range,ce(this,Vl),60))}static get observedAttributes(){return[...super.observedAttributes,u.MEDIA_PAUSED,u.MEDIA_DURATION,u.MEDIA_SEEKABLE,u.MEDIA_CURRENT_TIME,u.MEDIA_PREVIEW_IMAGE,u.MEDIA_PREVIEW_TIME,u.MEDIA_PREVIEW_CHAPTER,u.MEDIA_BUFFERED,u.MEDIA_PLAYBACK_RATE,u.MEDIA_LOADING,u.MEDIA_ENDED]}connectedCallback(){var e;super.connectedCallback(),this.range.setAttribute("aria-label",C("seek")),xe(this,Ta,Rr).call(this),tt(this,ba,this.getRootNode()),(e=ce(this,ba))==null||e.addEventListener("transitionstart",this)}disconnectedCallback(){var e;super.disconnectedCallback(),xe(this,Ta,Rr).call(this),(e=ce(this,ba))==null||e.removeEventListener("transitionstart",this),tt(this,ba,null)}attributeChangedCallback(e,i,a){super.attributeChangedCallback(e,i,a),i!=a&&(e===u.MEDIA_CURRENT_TIME||e===u.MEDIA_PAUSED||e===u.MEDIA_ENDED||e===u.MEDIA_LOADING||e===u.MEDIA_DURATION||e===u.MEDIA_SEEKABLE?(ce(this,Zi).update({start:In(this),duration:this.mediaSeekableEnd-this.mediaSeekableStart,playbackRate:this.mediaPlaybackRate}),xe(this,Ta,Rr).call(this),U1(this)):e===u.MEDIA_BUFFERED&&this.updateBufferedBar(),(e===u.MEDIA_DURATION||e===u.MEDIA_SEEKABLE)&&(this.mediaChaptersCues=ce(this,ga),this.updateBar()))}get mediaChaptersCues(){return ce(this,ga)}set mediaChaptersCues(e){var i;tt(this,ga,e),this.updateSegments((i=ce(this,ga))==null?void 0:i.map(a=>({start:In(this,a.startTime),end:In(this,a.endTime)})))}get mediaPaused(){return W(this,u.MEDIA_PAUSED)}set mediaPaused(e){F(this,u.MEDIA_PAUSED,e)}get mediaLoading(){return W(this,u.MEDIA_LOADING)}set mediaLoading(e){F(this,u.MEDIA_LOADING,e)}get mediaDuration(){return ie(this,u.MEDIA_DURATION)}set mediaDuration(e){de(this,u.MEDIA_DURATION,e)}get mediaCurrentTime(){return ie(this,u.MEDIA_CURRENT_TIME)}set mediaCurrentTime(e){de(this,u.MEDIA_CURRENT_TIME,e)}get mediaPlaybackRate(){return ie(this,u.MEDIA_PLAYBACK_RATE,1)}set mediaPlaybackRate(e){de(this,u.MEDIA_PLAYBACK_RATE,e)}get mediaBuffered(){const e=this.getAttribute(u.MEDIA_BUFFERED);return e?e.split(" ").map(i=>i.split(":").map(a=>+a)):[]}set mediaBuffered(e){if(!e){this.removeAttribute(u.MEDIA_BUFFERED);return}const i=e.map(a=>a.join(":")).join(" ");this.setAttribute(u.MEDIA_BUFFERED,i)}get mediaSeekable(){const e=this.getAttribute(u.MEDIA_SEEKABLE);if(e)return e.split(":").map(i=>+i)}set mediaSeekable(e){if(e==null){this.removeAttribute(u.MEDIA_SEEKABLE);return}this.setAttribute(u.MEDIA_SEEKABLE,e.join(":"))}get mediaSeekableEnd(){var e;const[,i=this.mediaDuration]=(e=this.mediaSeekable)!=null?e:[];return i}get mediaSeekableStart(){var e;const[i=0]=(e=this.mediaSeekable)!=null?e:[];return i}get mediaPreviewImage(){return ae(this,u.MEDIA_PREVIEW_IMAGE)}set mediaPreviewImage(e){re(this,u.MEDIA_PREVIEW_IMAGE,e)}get mediaPreviewTime(){return ie(this,u.MEDIA_PREVIEW_TIME)}set mediaPreviewTime(e){de(this,u.MEDIA_PREVIEW_TIME,e)}get mediaEnded(){return W(this,u.MEDIA_ENDED)}set mediaEnded(e){F(this,u.MEDIA_ENDED,e)}updateBar(){super.updateBar(),this.updateBufferedBar(),this.updateCurrentBox()}updateBufferedBar(){var e;const i=this.mediaBuffered;if(!i.length)return;let a;if(this.mediaEnded)a=1;else{const n=this.mediaCurrentTime,[,s=this.mediaSeekableStart]=(e=i.find(([o,l])=>o<=n&&n<=l))!=null?e:[];a=In(this,s)}const{style:r}=Ee(this.shadowRoot,"#buffered");r.setProperty("width",`${a*100}%`)}updateCurrentBox(){if(!this.shadowRoot.querySelector('slot[name="current"]').assignedElements().length)return;const i=Ee(this.shadowRoot,"#current-rail"),a=Ee(this.shadowRoot,'[part~="current-box"]'),r=xe(this,to,Eu).call(this,ce(this,ps)),n=xe(this,io,_u).call(this,r,this.range.valueAsNumber),s=xe(this,ao,bu).call(this,r,this.range.valueAsNumber);i.style.transform=`translateX(${n})`,i.style.setProperty("--_range-width",`${r.range.width}`),a.style.setProperty("--_box-shift",`${s}`),a.style.setProperty("--_box-width",`${r.box.width}px`),a.style.setProperty("visibility","initial")}handleEvent(e){switch(super.handleEvent(e),e.type){case"input":xe(this,ql,Qp).call(this);break;case"pointermove":xe(this,Kl,Gp).call(this,e);break;case"pointerup":ce(this,ya)&&tt(this,ya,!1);break;case"pointerdown":tt(this,ya,!0);break;case"pointerleave":xe(this,nn,ro).call(this,null);break;case"transitionstart":ri(e.target,this)&&setTimeout(()=>xe(this,Ta,Rr).call(this),0);break}}}ba=new WeakMap;Zi=new WeakMap;Js=new WeakMap;Wr=new WeakMap;eo=new WeakMap;ps=new WeakMap;an=new WeakMap;rn=new WeakMap;ga=new WeakMap;ya=new WeakMap;Ta=new WeakSet;Rr=function(){xe(this,fu,Yp).call(this)?ce(this,Zi).start():ce(this,Zi).stop()};fu=new WeakSet;Yp=function(){return this.isConnected&&!this.mediaPaused&&!this.mediaLoading&&!this.mediaEnded&&this.mediaSeekableEnd>0&&zm(this)};Vl=new WeakMap;to=new WeakSet;Eu=function(t){var e;const a=((e=this.getAttribute("bounds")?ja(this,`#${this.getAttribute("bounds")}`):this.parentElement)!=null?e:this).getBoundingClientRect(),r=this.range.getBoundingClientRect(),n=t.offsetWidth,s=-(r.left-a.left-n/2),o=a.right-r.left-n/2;return{box:{width:n,min:s,max:o},bounds:a,range:r}};io=new WeakSet;_u=function(t,e){let i=`${e*100}%`;const{width:a,min:r,max:n}=t.box;if(!a)return i;if(Number.isNaN(r)||(i=`max(${`calc(1 / var(--_range-width) * 100 * ${r}% + var(--media-box-padding-left))`}, ${i})`),!Number.isNaN(n)){const o=`calc(1 / var(--_range-width) * 100 * ${n}% - var(--media-box-padding-right))`;i=`min(${i}, ${o})`}return i};ao=new WeakSet;bu=function(t,e){const{width:i,min:a,max:r}=t.box,n=e*t.range.width;if(n<a+ce(this,an)){const s=t.range.left-t.bounds.left-ce(this,an);return`${n-i/2+s}px`}if(n>r-ce(this,rn)){const s=t.bounds.right-t.range.right-ce(this,rn);return`${n+i/2-s-t.range.width}px`}return 0};Kl=new WeakSet;Gp=function(t){const e=[...ce(this,Js)].some(m=>t.composedPath().includes(m));if(!this.dragging&&(e||!t.composedPath().includes(this))){xe(this,nn,ro).call(this,null);return}const i=this.mediaSeekableEnd;if(!i)return;const a=Ee(this.shadowRoot,"#preview-rail"),r=Ee(this.shadowRoot,'[part~="preview-box"]'),n=xe(this,to,Eu).call(this,ce(this,eo));let s=(t.clientX-n.range.left)/n.range.width;s=Math.max(0,Math.min(1,s));const o=xe(this,io,_u).call(this,n,s),l=xe(this,ao,bu).call(this,n,s);a.style.transform=`translateX(${o})`,a.style.setProperty("--_range-width",`${n.range.width}`),r.style.setProperty("--_box-shift",`${l}`),r.style.setProperty("--_box-width",`${n.box.width}px`);const d=Math.round(ce(this,Wr))-Math.round(s*i);Math.abs(d)<1&&s>.01&&s<.99||(tt(this,Wr,s*i),xe(this,nn,ro).call(this,ce(this,Wr)))};nn=new WeakSet;ro=function(t){this.dispatchEvent(new f.CustomEvent(R.MEDIA_PREVIEW_REQUEST,{composed:!0,bubbles:!0,detail:t}))};ql=new WeakSet;Qp=function(){ce(this,Zi).stop();const t=Zp(this);this.dispatchEvent(new f.CustomEvent(R.MEDIA_SEEK_REQUEST,{composed:!0,bubbles:!0,detail:t}))};gu.shadowRootOptions={mode:"open"};gu.getTemplateHTML=H1;f.customElements.get("media-time-range")||f.customElements.define("media-time-range",gu);const B1=1,W1=t=>t.mediaMuted?0:t.mediaVolume,F1=t=>`${Math.round(t*100)}%`;class V1 extends za{static get observedAttributes(){return[...super.observedAttributes,u.MEDIA_VOLUME,u.MEDIA_MUTED,u.MEDIA_VOLUME_UNAVAILABLE]}constructor(){super(),this.range.addEventListener("input",()=>{const e=this.range.value,i=new f.CustomEvent(R.MEDIA_VOLUME_REQUEST,{composed:!0,bubbles:!0,detail:e});this.dispatchEvent(i)})}connectedCallback(){super.connectedCallback(),this.range.setAttribute("aria-label",C("volume"))}attributeChangedCallback(e,i,a){super.attributeChangedCallback(e,i,a),(e===u.MEDIA_VOLUME||e===u.MEDIA_MUTED)&&(this.range.valueAsNumber=W1(this),this.range.setAttribute("aria-valuetext",F1(this.range.valueAsNumber)),this.updateBar())}get mediaVolume(){return ie(this,u.MEDIA_VOLUME,B1)}set mediaVolume(e){de(this,u.MEDIA_VOLUME,e)}get mediaMuted(){return W(this,u.MEDIA_MUTED)}set mediaMuted(e){F(this,u.MEDIA_MUTED,e)}get mediaVolumeUnavailable(){return ae(this,u.MEDIA_VOLUME_UNAVAILABLE)}set mediaVolumeUnavailable(e){re(this,u.MEDIA_VOLUME_UNAVAILABLE,e)}}f.customElements.get("media-volume-range")||f.customElements.define("media-volume-range",V1);var jp=(t,e,i)=>{if(!e.has(t))throw TypeError("Cannot "+i)},U=(t,e,i)=>(jp(t,e,"read from private field"),i?i.call(t):e.get(t)),$t=(t,e,i)=>{if(e.has(t))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(t):e.set(t,i)},Xt=(t,e,i,a)=>(jp(t,e,"write to private field"),e.set(t,i),i),Aa,vs,Oi,Cr,mi,pi,vi,Ni,ka,fs,mt;const uh=1,ch=0,K1=1,q1={processCallback(t,e,i){if(i){for(const[a,r]of e)if(a in i){const n=i[a];typeof n=="boolean"&&r instanceof bt&&typeof r.element[r.attributeName]=="boolean"?r.booleanValue=n:typeof n=="function"&&r instanceof bt?r.element[r.attributeName]=n:r.value=n}}}};class Mo extends f.DocumentFragment{constructor(e,i,a=q1){var r;super(),$t(this,Aa,void 0),$t(this,vs,void 0),this.append(e.content.cloneNode(!0)),Xt(this,Aa,zp(this)),Xt(this,vs,a),(r=a.createCallback)==null||r.call(a,this,U(this,Aa),i),a.processCallback(this,U(this,Aa),i)}update(e){U(this,vs).processCallback(this,U(this,Aa),e)}}Aa=new WeakMap;vs=new WeakMap;const zp=(t,e=[])=>{let i,a;for(const r of t.attributes||[])if(r.value.includes("{{")){const n=new G1;for([i,a]of mh(r.value))if(!i)n.append(a);else{const s=new bt(t,r.name,r.namespaceURI);n.append(s),e.push([a,s])}r.value=n.toString()}for(const r of t.childNodes)if(r.nodeType===uh&&!(r instanceof HTMLTemplateElement))zp(r,e);else{const n=r.data;if(r.nodeType===uh||n.includes("{{")){const s=[];if(n)for([i,a]of mh(n))if(!i)s.push(new Text(a));else{const o=new Xa(t);s.push(o),e.push([a,o])}else if(r instanceof HTMLTemplateElement){const o=new ev(t,r);s.push(o),e.push([o.expression,o])}r.replaceWith(...s.flatMap(o=>o.replacementNodes||[o]))}}return e},hh={},mh=t=>{let e="",i=0,a=hh[t],r=0,n;if(a)return a;for(a=[];n=t[r];r++)n==="{"&&t[r+1]==="{"&&t[r-1]!=="\\"&&t[r+2]&&++i==1?(e&&a.push([ch,e]),e="",r++):n==="}"&&t[r+1]==="}"&&t[r-1]!=="\\"&&!--i?(a.push([K1,e.trim()]),e="",r++):e+=n||"";return e&&a.push([ch,(i>0?"{{":"")+e]),hh[t]=a},Y1=11;class Xp{get value(){return""}set value(e){}toString(){return this.value}}const Jp=new WeakMap;class G1{constructor(){$t(this,Oi,[])}[Symbol.iterator](){return U(this,Oi).values()}get length(){return U(this,Oi).length}item(e){return U(this,Oi)[e]}append(...e){for(const i of e)i instanceof bt&&Jp.set(i,this),U(this,Oi).push(i)}toString(){return U(this,Oi).join("")}}Oi=new WeakMap;class bt extends Xp{constructor(e,i,a){super(),$t(this,Ni),$t(this,Cr,""),$t(this,mi,void 0),$t(this,pi,void 0),$t(this,vi,void 0),Xt(this,mi,e),Xt(this,pi,i),Xt(this,vi,a)}get attributeName(){return U(this,pi)}get attributeNamespace(){return U(this,vi)}get element(){return U(this,mi)}get value(){return U(this,Cr)}set value(e){U(this,Cr)!==e&&(Xt(this,Cr,e),!U(this,Ni,ka)||U(this,Ni,ka).length===1?e==null?U(this,mi).removeAttributeNS(U(this,vi),U(this,pi)):U(this,mi).setAttributeNS(U(this,vi),U(this,pi),e):U(this,mi).setAttributeNS(U(this,vi),U(this,pi),U(this,Ni,ka).toString()))}get booleanValue(){return U(this,mi).hasAttributeNS(U(this,vi),U(this,pi))}set booleanValue(e){if(!U(this,Ni,ka)||U(this,Ni,ka).length===1)this.value=e?"":null;else throw new DOMException("Value is not fully templatized")}}Cr=new WeakMap;mi=new WeakMap;pi=new WeakMap;vi=new WeakMap;Ni=new WeakSet;ka=function(){return Jp.get(this)};class Xa extends Xp{constructor(e,i){super(),$t(this,fs,void 0),$t(this,mt,void 0),Xt(this,fs,e),Xt(this,mt,i?[...i]:[new Text])}get replacementNodes(){return U(this,mt)}get parentNode(){return U(this,fs)}get nextSibling(){return U(this,mt)[U(this,mt).length-1].nextSibling}get previousSibling(){return U(this,mt)[0].previousSibling}get value(){return U(this,mt).map(e=>e.textContent).join("")}set value(e){this.replace(e)}replace(...e){const i=e.flat().flatMap(a=>a==null?[new Text]:a.forEach?[...a]:a.nodeType===Y1?[...a.childNodes]:a.nodeType?[a]:[new Text(a)]);i.length||i.push(new Text),Xt(this,mt,Q1(U(this,mt)[0].parentNode,U(this,mt),i,this.nextSibling))}}fs=new WeakMap;mt=new WeakMap;class ev extends Xa{constructor(e,i){const a=i.getAttribute("directive")||i.getAttribute("type");let r=i.getAttribute("expression")||i.getAttribute(a)||"";r.startsWith("{{")&&(r=r.trim().slice(2,-2).trim()),super(e),this.expression=r,this.template=i,this.directive=a}}function Q1(t,e,i,a=null){let r=0,n,s,o,l=i.length,d=e.length;for(;r<l&&r<d&&e[r]==i[r];)r++;for(;r<l&&r<d&&i[l-1]==e[d-1];)a=i[--d,--l];if(r==d)for(;r<l;)t.insertBefore(i[r++],a);if(r==l)for(;r<d;)t.removeChild(e[r++]);else{for(n=e[r];r<l;)o=i[r++],s=n?n.nextSibling:a,n==o?n=s:r<l&&i[r]==s?(t.replaceChild(o,n),n=s):t.insertBefore(o,n);for(;n!=a;)s=n.nextSibling,t.removeChild(n),n=s}return i}const ph={string:t=>String(t)};class tv{constructor(e){this.template=e,this.state=void 0}}const Ki=new WeakMap,qi=new WeakMap,Yl={partial:(t,e)=>{e[t.expression]=new tv(t.template)},if:(t,e)=>{var i;if(iv(t.expression,e))if(Ki.get(t)!==t.template){Ki.set(t,t.template);const a=new Mo(t.template,e,yu);t.replace(a),qi.set(t,a)}else(i=qi.get(t))==null||i.update(e);else t.replace(""),Ki.delete(t),qi.delete(t)}},Z1=Object.keys(Yl),yu={processCallback(t,e,i){var a,r;if(i)for(const[n,s]of e){if(s instanceof ev){if(!s.directive){const l=Z1.find(d=>s.template.hasAttribute(d));l&&(s.directive=l,s.expression=s.template.getAttribute(l))}(a=Yl[s.directive])==null||a.call(Yl,s,i);continue}let o=iv(n,i);if(o instanceof tv){Ki.get(s)!==o.template?(Ki.set(s,o.template),o=new Mo(o.template,o.state,yu),s.value=o,qi.set(s,o)):(r=qi.get(s))==null||r.update(o.state);continue}o?(s instanceof bt&&s.attributeName.startsWith("aria-")&&(o=String(o)),s instanceof bt?typeof o=="boolean"?s.booleanValue=o:typeof o=="function"?s.element[s.attributeName]=o:s.value=o:(s.value=o,Ki.delete(s),qi.delete(s))):s instanceof bt?s.value=void 0:(s.value=void 0,Ki.delete(s),qi.delete(s))}}},vh={"!":t=>!t,"!!":t=>!!t,"==":(t,e)=>t==e,"!=":(t,e)=>t!=e,">":(t,e)=>t>e,">=":(t,e)=>t>=e,"<":(t,e)=>t<e,"<=":(t,e)=>t<=e,"??":(t,e)=>t??e,"|":(t,e)=>{var i;return(i=ph[e])==null?void 0:i.call(ph,t)}};function j1(t){return z1(t,{boolean:/true|false/,number:/-?\d+\.?\d*/,string:/(["'])((?:\\.|[^\\])*?)\1/,operator:/[!=><][=!]?|\?\?|\|/,ws:/\s+/,param:/[$a-z_][$\w]*/i}).filter(({type:e})=>e!=="ws")}function iv(t,e={}){var i,a,r,n,s,o,l;const d=j1(t);if(d.length===0||d.some(({type:m})=>!m))return or(t);if(((i=d[0])==null?void 0:i.token)===">"){const m=e[(a=d[1])==null?void 0:a.token];if(!m)return or(t);const p={...e};m.state=p;const h=d.slice(2);for(let c=0;c<h.length;c+=3){const v=(r=h[c])==null?void 0:r.token,g=(n=h[c+1])==null?void 0:n.token,_=(s=h[c+2])==null?void 0:s.token;v&&g==="="&&(p[v]=lr(_,e))}return m}if(d.length===1)return Rn(d[0])?lr(d[0].token,e):or(t);if(d.length===2){const m=(o=d[0])==null?void 0:o.token,p=vh[m];if(!p||!Rn(d[1]))return or(t);const h=lr(d[1].token,e);return p(h)}if(d.length===3){const m=(l=d[1])==null?void 0:l.token,p=vh[m];if(!p||!Rn(d[0])||!Rn(d[2]))return or(t);const h=lr(d[0].token,e);if(m==="|")return p(h,d[2].token);const c=lr(d[2].token,e);return p(h,c)}}function or(t){return!1}function Rn({type:t}){return["number","boolean","string","param"].includes(t)}function lr(t,e){const i=t[0],a=t.slice(-1);return t==="true"||t==="false"?t==="true":i===a&&["'",'"'].includes(i)?t.slice(1,-1):Wm(t)?parseFloat(t):e[t]}function z1(t,e){let i,a,r;const n=[];for(;t;){r=null,i=t.length;for(const s in e)a=e[s].exec(t),a&&a.index<i&&(r={token:a[0],type:s,matches:a.slice(1)},i=a.index);i&&n.push({token:t.substr(0,i),type:void 0}),r&&n.push(r),t=t.substr(i+(r?r.token.length:0))}return n}var Tu=(t,e,i)=>{if(!e.has(t))throw TypeError("Cannot "+i)},Gl=(t,e,i)=>(Tu(t,e,"read from private field"),i?i.call(t):e.get(t)),dr=(t,e,i)=>{if(e.has(t))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(t):e.set(t,i)},Yi=(t,e,i,a)=>(Tu(t,e,"write to private field"),e.set(t,i),i),Jo=(t,e,i)=>(Tu(t,e,"access private method"),i),Pa,Es,$a,Ql,av,_s,Zl;const el={mediatargetlivewindow:"targetlivewindow",mediastreamtype:"streamtype"},rv=Te.createElement("template");rv.innerHTML=`
  <style>
    :host {
      display: inline-block;
      line-height: 0;
...
`;class xo extends f.HTMLElement{constructor(){super(),dr(this,Ql),dr(this,_s),dr(this,Pa,void 0),dr(this,Es,void 0),dr(this,$a,void 0),this.shadowRoot?this.renderRoot=this.shadowRoot:(this.renderRoot=this.attachShadow({mode:"open"}),this.createRenderer());const e=new MutationObserver(i=>{var a;this.mediaController&&!((a=this.mediaController)!=null&&a.breakpointsComputed)||i.some(r=>{const n=r.target;return n===this?!0:n.localName!=="media-controller"?!1:!!(el[r.attributeName]||r.attributeName.startsWith("breakpoint"))})&&this.render()});e.observe(this,{attributes:!0}),e.observe(this.renderRoot,{attributes:!0,subtree:!0}),this.addEventListener(ii.BREAKPOINTS_COMPUTED,this.render),Jo(this,Ql,av).call(this,"template")}get mediaController(){return this.renderRoot.querySelector("media-controller")}get template(){var e;return(e=Gl(this,Pa))!=null?e:this.constructor.template}set template(e){if(e===null){this.removeAttribute("template");return}typeof e=="string"?this.setAttribute("template",e):e instanceof HTMLTemplateElement&&(Yi(this,Pa,e),Yi(this,$a,null),this.createRenderer())}get props(){var e,i,a;const r=[...Array.from((i=(e=this.mediaController)==null?void 0:e.attributes)!=null?i:[]).filter(({name:s})=>el[s]||s.startsWith("breakpoint")),...Array.from(this.attributes)],n={};for(const s of r){const o=(a=el[s.name])!=null?a:lg(s.name);let{value:l}=s;l!=null?(Wm(l)&&(l=parseFloat(l)),n[o]=l===""?!0:l):n[o]=!1}return n}attributeChangedCallback(e,i,a){e==="template"&&i!=a&&Jo(this,_s,Zl).call(this)}connectedCallback(){Jo(this,_s,Zl).call(this)}createRenderer(){this.template instanceof HTMLTemplateElement&&this.template!==Gl(this,Es)&&(Yi(this,Es,this.template),this.renderer=new Mo(this.template,this.props,this.constructor.processor),this.renderRoot.textContent="",this.renderRoot.append(rv.content.cloneNode(!0),this.renderer))}render(){var e;(e=this.renderer)==null||e.update(this.props)}}Pa=new WeakMap;Es=new WeakMap;$a=new WeakMap;Ql=new WeakSet;av=function(t){if(Object.prototype.hasOwnProperty.call(this,t)){const e=this[t];delete this[t],this[t]=e}};_s=new WeakSet;Zl=function(){var t;const e=this.getAttribute("template");if(!e||e===Gl(this,$a))return;const i=this.getRootNode(),a=(t=i?.getElementById)==null?void 0:t.call(i,e);if(a){Yi(this,$a,e),Yi(this,Pa,a),this.createRenderer();return}X1(e)&&(Yi(this,$a,e),J1(e).then(r=>{const n=Te.createElement("template");n.innerHTML=r,Yi(this,Pa,n),this.createRenderer()}).catch(console.error))};xo.observedAttributes=["template"];xo.processor=yu;function X1(t){if(!/^(\/|\.\/|https?:\/\/)/.test(t))return!1;const e=/^https?:\/\//.test(t)?void 0:location.origin;try{new URL(t,e)}catch{return!1}return!0}async function J1(t){const e=await fetch(t);if(e.status!==200)throw new Error(`Failed to load resource: the server responded with a status of ${e.status}`);return e.text()}f.customElements.get("media-theme")||f.customElements.define("media-theme",xo);function ey({anchor:t,floating:e,placement:i}){const a=ty({anchor:t,floating:e}),{x:r,y:n}=ay(a,i);return{x:r,y:n}}function ty({anchor:t,floating:e}){return{anchor:iy(t,e.offsetParent),floating:{x:0,y:0,width:e.offsetWidth,height:e.offsetHeight}}}function iy(t,e){var i;const a=t.getBoundingClientRect(),r=(i=e?.getBoundingClientRect())!=null?i:{x:0,y:0};return{x:a.x-r.x,y:a.y-r.y,width:a.width,height:a.height}}function ay({anchor:t,floating:e},i){const a=ry(i)==="x"?"y":"x",r=a==="y"?"height":"width",n=nv(i),s=t.x+t.width/2-e.width/2,o=t.y+t.height/2-e.height/2,l=t[r]/2-e[r]/2;let d;switch(n){case"top":d={x:s,y:t.y-e.height};break;case"bottom":d={x:s,y:t.y+t.height};break;case"right":d={x:t.x+t.width,y:o};break;case"left":d={x:t.x-e.width,y:o};break;default:d={x:t.x,y:t.y}}switch(i.split("-")[1]){case"start":d[a]-=l;break;case"end":d[a]+=l;break}return d}function nv(t){return t.split("-")[0]}function ry(t){return["top","bottom"].includes(nv(t))?"y":"x"}class Au extends Event{constructor({action:e="auto",relatedTarget:i,...a}){super("invoke",a),this.action=e,this.relatedTarget=i}}class ny extends Event{constructor({newState:e,oldState:i,...a}){super("toggle",a),this.newState=e,this.oldState=i}}var ku=(t,e,i)=>{if(!e.has(t))throw TypeError("Cannot "+i)},K=(t,e,i)=>(ku(t,e,"read from private field"),i?i.call(t):e.get(t)),j=(t,e,i)=>{if(e.has(t))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(t):e.set(t,i)},Ot=(t,e,i,a)=>(ku(t,e,"write to private field"),e.set(t,i),i),z=(t,e,i)=>(ku(t,e,"access private method"),i),Nt,ji,Ai,bs,gs,zi,sn,jl,sv,no,Su,so,ys,zl,Xl,ov,Jl,lv,ed,dv,Ua,Ha,Ba,on,oo,wu,td,uv,Iu,cv,id,hv,Ru,mv,ad,pv,rd,vv,Fr,lo,nd,fv,Vr,uo,Ts,sd;function Ga({type:t,text:e,value:i,checked:a}){const r=Te.createElement("media-chrome-menu-item");r.type=t,r.part.add("menu-item"),r.part.add(t),r.value=i,r.checked=a;const n=Te.createElement("span");return n.textContent=e,r.append(n),r}function Xi(t,e){let i=t.querySelector(`:scope > [slot="${e}"]`);if(i?.nodeName=="SLOT"&&(i=i.assignedElements({flatten:!0})[0]),i)return i=i.cloneNode(!0),i;const a=t.shadowRoot.querySelector(`[name="${e}"] > svg`);return a?a.cloneNode(!0):""}function sy(t){return`
    <style>
      :host {
        font: var(--media-font,
          var(--media-font-weight, normal)
  ...
  `}const Ri={STYLE:"style",HIDDEN:"hidden",DISABLED:"disabled",ANCHOR:"anchor"};class ot extends f.HTMLElement{constructor(){if(super(),j(this,jl),j(this,no),j(this,ys),j(this,Xl),j(this,Jl),j(this,ed),j(this,Ba),j(this,oo),j(this,td),j(this,Iu),j(this,id),j(this,Ru),j(this,ad),j(this,rd),j(this,Fr),j(this,nd),j(this,Vr),j(this,Ts),j(this,Nt,null),j(this,ji,null),j(this,Ai,null),j(this,bs,new Set),j(this,gs,void 0),j(this,zi,!1),j(this,sn,null),j(this,so,()=>{const e=K(this,bs),i=new Set(this.items);for(const a of e)i.has(a)||this.dispatchEvent(new CustomEvent("removemenuitem",{detail:a}));for(const a of i)e.has(a)||this.dispatchEvent(new CustomEvent("addmenuitem",{detail:a}));Ot(this,bs,i)}),j(this,Ua,()=>{z(this,Ba,on).call(this),z(this,oo,wu).call(this,!1)}),j(this,Ha,()=>{z(this,Ba,on).call(this)}),!this.shadowRoot){this.attachShadow(this.constructor.shadowRootOptions);const e=Xe(this.attributes);this.shadowRoot.innerHTML=this.constructor.getTemplateHTML(e)}this.container=this.shadowRoot.querySelector("#container"),this.defaultSlot=this.shadowRoot.querySelector("slot:not([name])"),this.shadowRoot.addEventListener("slotchange",this),Ot(this,gs,new MutationObserver(K(this,so))),K(this,gs).observe(this.defaultSlot,{childList:!0})}static get observedAttributes(){return[Ri.DISABLED,Ri.HIDDEN,Ri.STYLE,Ri.ANCHOR,q.MEDIA_CONTROLLER]}static formatMenuItemText(e,i){return e}enable(){this.addEventListener("click",this),this.addEventListener("focusout",this),this.addEventListener("keydown",this),this.addEventListener("invoke",this),this.addEventListener("toggle",this)}disable(){this.removeEventListener("click",this),this.removeEventListener("focusout",this),this.removeEventListener("keyup",this),this.removeEventListener("invoke",this),this.removeEventListener("toggle",this)}handleEvent(e){switch(e.type){case"slotchange":z(this,jl,sv).call(this,e);break;case"invoke":z(this,Xl,ov).call(this,e);break;case"click":z(this,td,uv).call(this,e);break;case"toggle":z(this,id,hv).call(this,e);break;case"focusout":z(this,ad,pv).call(this,e);break;case"keydown":z(this,rd,vv).call(this,e);break}}connectedCallback(){var e,i;Ot(this,sn,Xm(this.shadowRoot,":host")),z(this,ys,zl).call(this),this.hasAttribute("disabled")||this.enable(),this.role||(this.role="menu"),Ot(this,Nt,yl(this)),(i=(e=K(this,Nt))==null?void 0:e.associateElement)==null||i.call(e,this),this.hidden||(Va(ln(this),K(this,Ua)),Va(this,K(this,Ha))),z(this,no,Su).call(this)}disconnectedCallback(){var e,i;Ka(ln(this),K(this,Ua)),Ka(this,K(this,Ha)),this.disable(),(i=(e=K(this,Nt))==null?void 0:e.unassociateElement)==null||i.call(e,this),Ot(this,Nt,null)}attributeChangedCallback(e,i,a){var r,n,s,o;e===Ri.HIDDEN&&a!==i?(K(this,zi)||Ot(this,zi,!0),this.hidden?z(this,ed,dv).call(this):z(this,Jl,lv).call(this),this.dispatchEvent(new ny({oldState:this.hidden?"open":"closed",newState:this.hidden?"closed":"open",bubbles:!0}))):e===q.MEDIA_CONTROLLER?(i&&((n=(r=K(this,Nt))==null?void 0:r.unassociateElement)==null||n.call(r,this),Ot(this,Nt,null)),a&&this.isConnected&&(Ot(this,Nt,yl(this)),(o=(s=K(this,Nt))==null?void 0:s.associateElement)==null||o.call(s,this))):e===Ri.DISABLED&&a!==i?a==null?this.enable():this.disable():e===Ri.STYLE&&a!==i&&z(this,ys,zl).call(this)}formatMenuItemText(e,i){return this.constructor.formatMenuItemText(e,i)}get anchor(){return this.getAttribute("anchor")}set anchor(e){this.setAttribute("anchor",`${e}`)}get anchorElement(){var e;return this.anchor?(e=yo(this))==null?void 0:e.querySelector(`#${this.anchor}`):null}get items(){return this.defaultSlot.assignedElements({flatten:!0}).filter(oy)}get radioGroupItems(){return this.items.filter(e=>e.role==="menuitemradio")}get checkedItems(){return this.items.filter(e=>e.checked)}get value(){var e,i;return(i=(e=this.checkedItems[0])==null?void 0:e.value)!=null?i:""}set value(e){const i=this.items.find(a=>a.value===e);i&&z(this,Ts,sd).call(this,i)}focus(){if(Ot(this,ji,Vd()),this.items.length){z(this,Vr,uo).call(this,this.items[0]),this.items[0].focus();return}const e=this.querySelector('[autofocus], [tabindex]:not([tabindex="-1"]), [role="menu"]');e?.focus()}handleSelect(e){var i;const a=z(this,Fr,lo).call(this,e);a&&(z(this,Ts,sd).call(this,a,a.type==="checkbox"),K(this,Ai)&&!this.hidden&&((i=K(this,ji))==null||i.focus(),this.hidden=!0))}get keysUsed(){return["Enter","Escape","Tab"," ","ArrowDown","ArrowUp","Home","End"]}handleMove(e){var i,a;const{key:r}=e,n=this.items,s=(a=(i=z(this,Fr,lo).call(this,e))!=null?i:z(this,nd,fv).call(this))!=null?a:n[0],o=n.indexOf(s);let l=Math.max(0,o);r==="ArrowDown"?l++:r==="ArrowUp"?l--:e.key==="Home"?l=0:e.key==="End"&&(l=n.length-1),l<0&&(l=n.length-1),l>n.length-1&&(l=0),z(this,Vr,uo).call(this,n[l]),n[l].focus()}}Nt=new WeakMap;ji=new WeakMap;Ai=new WeakMap;bs=new WeakMap;gs=new WeakMap;zi=new WeakMap;sn=new WeakMap;jl=new WeakSet;sv=function(t){const e=t.target;for(const i of e.assignedNodes({flatten:!0}))i.nodeType===3&&i.textContent.trim()===""&&i.remove();["header","title"].includes(e.name)&&z(this,no,Su).call(this),e.name||K(this,so).call(this)};no=new WeakSet;Su=function(){const t=this.shadowRoot.querySelector('slot[name="header"]'),e=this.shadowRoot.querySelector('slot[name="title"]');t.hidden=e.assignedNodes().length===0&&t.assignedNodes().length===0};so=new WeakMap;ys=new WeakSet;zl=function(){var t;const e=this.shadowRoot.querySelector("#layout-row"),i=(t=getComputedStyle(this).getPropertyValue("--media-menu-layout"))==null?void 0:t.trim();e.setAttribute("media",i==="row"?"":"width:0")};Xl=new WeakSet;ov=function(t){Ot(this,Ai,t.relatedTarget),ri(this,t.relatedTarget)||(this.hidden=!this.hidden)};Jl=new WeakSet;lv=function(){var t;(t=K(this,Ai))==null||t.setAttribute("aria-expanded","true"),this.addEventListener("transitionend",()=>this.focus(),{once:!0}),Va(ln(this),K(this,Ua)),Va(this,K(this,Ha))};ed=new WeakSet;dv=function(){var t;(t=K(this,Ai))==null||t.setAttribute("aria-expanded","false"),Ka(ln(this),K(this,Ua)),Ka(this,K(this,Ha))};Ua=new WeakMap;Ha=new WeakMap;Ba=new WeakSet;on=function(t){if(this.hasAttribute("mediacontroller")&&!this.anchor||this.hidden||!this.anchorElement)return;const{x:e,y:i}=ey({anchor:this.anchorElement,floating:this,placement:"top-start"});t??(t=this.offsetWidth);const r=ln(this).getBoundingClientRect(),n=r.width-e-t,s=r.height-i-this.offsetHeight,{style:o}=K(this,sn);o.setProperty("position","absolute"),o.setProperty("right",`${Math.max(0,n)}px`),o.setProperty("--_menu-bottom",`${s}px`);const l=getComputedStyle(this),m=o.getPropertyValue("--_menu-bottom")===l.bottom?s:parseFloat(l.bottom),p=r.height-m-parseFloat(l.marginBottom);this.style.setProperty("--_menu-max-height",`${p}px`)};oo=new WeakSet;wu=function(t){const e=this.querySelector('[role="menuitem"][aria-haspopup][aria-expanded="true"]'),i=e?.querySelector('[role="menu"]'),{style:a}=K(this,sn);if(t||a.setProperty("--media-menu-transition-in","none"),i){const r=i.offsetHeight,n=Math.max(i.offsetWidth,e.offsetWidth);this.style.setProperty("min-width",`${n}px`),this.style.setProperty("min-height",`${r}px`),z(this,Ba,on).call(this,n)}else this.style.removeProperty("min-width"),this.style.removeProperty("min-height"),z(this,Ba,on).call(this);a.removeProperty("--media-menu-transition-in")};td=new WeakSet;uv=function(t){var e;if(t.stopPropagation(),t.composedPath().includes(K(this,Iu,cv))){(e=K(this,ji))==null||e.focus(),this.hidden=!0;return}const i=z(this,Fr,lo).call(this,t);!i||i.hasAttribute("disabled")||(z(this,Vr,uo).call(this,i),this.handleSelect(t))};Iu=new WeakSet;cv=function(){var t;return(t=this.shadowRoot.querySelector('slot[name="header"]').assignedElements({flatten:!0}))==null?void 0:t.find(i=>i.matches('button[part~="back"]'))};id=new WeakSet;hv=function(t){if(t.target===this)return;z(this,Ru,mv).call(this);const e=Array.from(this.querySelectorAll('[role="menuitem"][aria-haspopup]'));for(const i of e)i.invokeTargetElement!=t.target&&t.newState=="open"&&i.getAttribute("aria-expanded")=="true"&&!i.invokeTargetElement.hidden&&i.invokeTargetElement.dispatchEvent(new Au({relatedTarget:i}));for(const i of e)i.setAttribute("aria-expanded",`${!i.submenuElement.hidden}`);z(this,oo,wu).call(this,!0)};Ru=new WeakSet;mv=function(){const e=this.querySelector('[role="menuitem"] > [role="menu"]:not([hidden])');this.container.classList.toggle("has-expanded",!!e)};ad=new WeakSet;pv=function(t){var e;ri(this,t.relatedTarget)||(K(this,zi)&&((e=K(this,ji))==null||e.focus()),K(this,Ai)&&K(this,Ai)!==t.relatedTarget&&!this.hidden&&(this.hidden=!0))};rd=new WeakSet;vv=function(t){var e,i,a,r,n;const{key:s,ctrlKey:o,altKey:l,metaKey:d}=t;if(!(o||l||d)&&this.keysUsed.includes(s))if(t.preventDefault(),t.stopPropagation(),s==="Tab"){if(K(this,zi)){this.hidden=!0;return}t.shiftKey?(i=(e=this.previousElementSibling)==null?void 0:e.focus)==null||i.call(e):(r=(a=this.nextElementSibling)==null?void 0:a.focus)==null||r.call(a),this.blur()}else s==="Escape"?((n=K(this,ji))==null||n.focus(),K(this,zi)&&(this.hidden=!0)):s==="Enter"||s===" "?this.handleSelect(t):this.handleMove(t)};Fr=new WeakSet;lo=function(t){return t.composedPath().find(e=>["menuitemradio","menuitemcheckbox"].includes(e.role))};nd=new WeakSet;fv=function(){return this.items.find(t=>t.tabIndex===0)};Vr=new WeakSet;uo=function(t){for(const e of this.items)e.tabIndex=e===t?0:-1};Ts=new WeakSet;sd=function(t,e){const i=[...this.checkedItems];t.type==="radio"&&this.radioGroupItems.forEach(a=>a.checked=!1),e?t.checked=!t.checked:t.checked=!0,this.checkedItems.some((a,r)=>a!=i[r])&&this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))};ot.shadowRootOptions={mode:"open"};ot.getTemplateHTML=sy;function oy(t){return["menuitem","menuitemradio","menuitemcheckbox"].includes(t?.role)}function ln(t){var e;return(e=t.getAttribute("bounds")?ja(t,`#${t.getAttribute("bounds")}`):Ue(t)||t.parentElement)!=null?e:t}f.customElements.get("media-chrome-menu")||f.customElements.define("media-chrome-menu",ot);var Cu=(t,e,i)=>{if(!e.has(t))throw TypeError("Cannot "+i)},Bt=(t,e,i)=>(Cu(t,e,"read from private field"),i?i.call(t):e.get(t)),Gt=(t,e,i)=>{if(e.has(t))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(t):e.set(t,i)},tl=(t,e,i,a)=>(Cu(t,e,"write to private field"),e.set(t,i),i),_t=(t,e,i)=>(Cu(t,e,"access private method"),i),As,Kr,od,Ev,co,Du,Lu,_v,Wt,Qa,dn,ld,bv,ks,dd;function ly(t){return`
    <style>
      :host {
  ...
  `}class gv extends ot{get anchorElement(){return this.anchor!=="auto"?super.anchorElement:Ue(this).querySelector("media-settings-menu-button")}}gv.getTemplateHTML=uy;f.customElements.get("media-settings-menu")||f.customElements.define("media-settings-menu",gv);function cy(t){return`
  ...
  `}function py(){return C("Settings")}class Mu extends Ja{static get observedAttributes(){return[...super.observedAttributes,"target"]}connectedCallback(){super.connectedCallback(),this.setAttribute("aria-label",C("settings"))}get invokeTargetElement(){return this.invokeTarget!=null?super.invokeTargetElement:Ue(this).querySelector("media-settings-menu")}}Mu.getSlotTemplateHTML=my;Mu.getTooltipContentHTML=py;f.customElements.get("media-settings-menu-button")||f.customElements.define("media-settings-menu-button",Mu);var xu=(t,e,i)=>{if(!e.has(t))throw TypeError("Cannot "+i)},yv=(t,e,i)=>(xu(t,e,"read from private field"),i?i.call(t):e.get(t)),Cn=(t,e,i)=>{if(e.has(t))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(t):e.set(t,i)},cd=(t,e,i,a)=>(xu(t,e,"write to private field"),e.set(t,i),i),Dn=(t,e,i)=>(xu(t,e,"access private method"),i),Dr,ho,Ss,hd,ws,md;class vy extends ot{constructor(){super(...arguments),Cn(this,Ss),Cn(this,ws),Cn(this,Dr,[]),Cn(this,ho,void 0)}static get observedAttributes(){return[...super.observedAttributes,u.MEDIA_AUDIO_TRACK_LIST,u.MEDIA_AUDIO_TRACK_ENABLED,u.MEDIA_AUDIO_TRACK_UNAVAILABLE]}attributeChangedCallback(e,i,a){super.attributeChangedCallback(e,i,a),e===u.MEDIA_AUDIO_TRACK_ENABLED&&i!==a?this.value=a:e===u.MEDIA_AUDIO_TRACK_LIST&&i!==a&&(cd(this,Dr,ng(a??"")),Dn(this,Ss,hd).call(this))}connectedCallback(){super.connectedCallback(),this.addEventListener("change",Dn(this,ws,md))}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("change",Dn(this,ws,md))}get anchorElement(){var e;return this.anchor!=="auto"?super.anchorElement:(e=Ue(this))==null?void 0:e.querySelector("media-audio-track-menu-button")}get mediaAudioTrackList(){return yv(this,Dr)}set mediaAudioTrackList(e){cd(this,Dr,e),Dn(this,Ss,hd).call(this)}get mediaAudioTrackEnabled(){var e;return(e=ae(this,u.MEDIA_AUDIO_TRACK_ENABLED))!=null?e:""}set mediaAudioTrackEnabled(e){re(this,u.MEDIA_AUDIO_TRACK_ENABLED,e)}}Dr=new WeakMap;ho=new WeakMap;Ss=new WeakSet;hd=function(){if(yv(this,ho)===JSON.stringify(this.mediaAudioTrackList))return;cd(this,ho,JSON.stringify(this.mediaAudioTrackList));const t=this.mediaAudioTrackList;this.defaultSlot.textContent="",t.sort((e,i)=>e.id.localeCompare(i.id,void 0,{numeric:!0}));for(const e of t){const i=this.formatMenuItemText(e.label,e),a=Ga({type:"radio",text:i,value:`${e.id}`,checked:e.enabled});a.prepend(Xi(this,"checked-indicator")),this.defaultSlot.append(a)}};ws=new WeakSet;md=function(){if(this.value==null)return;const t=new f.CustomEvent(R.MEDIA_AUDIO_TRACK_REQUEST,{composed:!0,bubbles:!0,detail:this.value});this.dispatchEvent(t)};f.customElements.get("media-audio-track-menu")||f.customElements.define("media-audio-track-menu",vy);const fy=`<svg aria-hidden="true" viewBox="0 0 24 24">
  ...
  `}function _y(){return C("Audio")}const fh=t=>{const e=C("Audio");t.setAttribute("aria-label",e)};class Ou extends Ja{static get observedAttributes(){return[...super.observedAttributes,u.MEDIA_AUDIO_TRACK_ENABLED,u.MEDIA_AUDIO_TRACK_UNAVAILABLE]}connectedCallback(){super.connectedCallback(),fh(this)}attributeChangedCallback(e,i,a){super.attributeChangedCallback(e,i,a),e===u.MEDIA_LANG&&fh(this)}get invokeTargetElement(){var e;return this.invokeTarget!=null?super.invokeTargetElement:(e=Ue(this))==null?void 0:e.querySelector("media-audio-track-menu")}get mediaAudioTrackEnabled(){var e;return(e=ae(this,u.MEDIA_AUDIO_TRACK_ENABLED))!=null?e:""}set mediaAudioTrackEnabled(e){re(this,u.MEDIA_AUDIO_TRACK_ENABLED,e)}}Ou.getSlotTemplateHTML=Ey;Ou.getTooltipContentHTML=_y;f.customElements.get("media-audio-track-menu-button")||f.customElements.define("media-audio-track-menu-button",Ou);var Nu=(t,e,i)=>{if(!e.has(t))throw TypeError("Cannot "+i)},by=(t,e,i)=>(Nu(t,e,"read from private field"),e.get(t)),il=(t,e,i)=>{if(e.has(t))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(t):e.set(t,i)},gy=(t,e,i,a)=>(Nu(t,e,"write to private field"),e.set(t,i),i),al=(t,e,i)=>(Nu(t,e,"access private method"),i),mo,pd,Tv,Is,vd;const yy=`
  <svg aria-hidden="true" viewBox="0 0 26 24" part="captions-indicator indicator">
    <path d="M22.83 5.68a2.58 2.58 0 0 0-2.3-2.5c-3.62-.24-11.44-.24-15.06 0a2.58 2.58 0 0 0-2.3 2.5c-.23 4.21-.23 8.43 0 12.64a2.58 2.58 0 0 0 2.3 2.5c3.62.24 11.44.24 15.06 0a2.58 2.58 0 0 0 2.3-2.5c.23-4.21.23-8.43 0-12.64Zm-11.39 9.45a3.07 3.07 0 0 1-1.91.57 3.06 3.06 0 0 1-2.34-1 3.75 3.75 0 0 1-.92-2.67 3.92 3.92 0 0 1 .92-2.77 3.18 3.18 0 0 1 2.43-1 2.94 2.94 0 0 1 2.13.78c.364.359.62.813.74 1.31l-1.43.35a1.49 1.49 0 0 0-1.51-1.17 1.61 1.61 0 0 0-1.29.58 2.79 2.79 0 0 0-.5 1.89 3 3 0 0 0 .49 1.93 1.61 1.61 0 0 0 1.27.58 1.48 1.48 0 0 0 1-.37 2.1 2.1 0 0 0 .59-1.14l1.4.44a3.23 3.23 0 0 1-1.07 1.69Zm7.22 0a3.07 3.07 0 0 1-1.91.57 3.06 3.06 0 0 1-2.34-1 3.75 3.75 0 0 1-.92-2.67 3.88 3.88 0 0 1 .93-2.77 3.14 3.14 0 0 1 2.42-1 3 3 0 0 1 2.16.82 2.8 2.8 0 0 1 .73 1.31l-1.43.35a1.49 1.49 0 0 0-1.51-1.21 1.61 1.61 0 0 0-1.29.58A2.79 2.79 0 0 0 15 12a3 3 0 0 0 .49 1.93 1.61 1.61 0 0 0 1.27.58 1.44 1.44 0 0 0 1-.37 2.1 2.1 0 0 0 .6-1.15l1.4.44a3.17 3.17 0 0 1-1.1 1.7Z"/>
  </svg>`;function Ty(t){return`
    ${ot.getTemplateHTML(t)}
    <slot name="captions-indicator" hidden>${yy}</slot>
  `}class Av extends ot{constructor(){super(...arguments),il(this,pd),il(this,Is),il(this,mo,void 0)}static get observedAttributes(){return[...super.observedAttributes,u.MEDIA_SUBTITLES_LIST,u.MEDIA_SUBTITLES_SHOWING]}attributeChangedCallback(e,i,a){super.attributeChangedCallback(e,i,a),e===u.MEDIA_SUBTITLES_LIST&&i!==a?al(this,pd,Tv).call(this):e===u.MEDIA_SUBTITLES_SHOWING&&i!==a&&(this.value=a)}connectedCallback(){super.connectedCallback(),this.addEventListener("change",al(this,Is,vd))}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("change",al(this,Is,vd))}get anchorElement(){return this.anchor!=="auto"?super.anchorElement:Ue(this).querySelector("media-captions-menu-button")}get mediaSubtitlesList(){return Eh(this,u.MEDIA_SUBTITLES_LIST)}set mediaSubtitlesList(e){_h(this,u.MEDIA_SUBTITLES_LIST,e)}get mediaSubtitlesShowing(){return Eh(this,u.MEDIA_SUBTITLES_SHOWING)}set mediaSubtitlesShowing(e){_h(this,u.MEDIA_SUBTITLES_SHOWING,e)}}mo=new WeakMap;pd=new WeakSet;Tv=function(){var t;if(by(this,mo)===JSON.stringify(this.mediaSubtitlesList))return;gy(this,mo,JSON.stringify(this.mediaSubtitlesList)),this.defaultSlot.textContent="";const e=!this.value,i=Ga({type:"radio",text:this.formatMenuItemText(C("Off")),value:"off",checked:e});i.prepend(Xi(this,"checked-indicator")),this.defaultSlot.append(i);const a=this.mediaSubtitlesList;for(const r of a){const n=Ga({type:"radio",text:this.formatMenuItemText(r.label,r),value:Sl(r),checked:this.value==Sl(r)});n.prepend(Xi(this,"checked-indicator")),((t=r.kind)!=null?t:"subs")==="captions"&&n.append(Xi(this,"captions-indicator")),this.defaultSlot.append(n)}};Is=new WeakSet;vd=function(){const t=this.mediaSubtitlesShowing,e=this.getAttribute(u.MEDIA_SUBTITLES_SHOWING),i=this.value!==e;if(t?.length&&i&&this.dispatchEvent(new f.CustomEvent(R.MEDIA_DISABLE_SUBTITLES_REQUEST,{composed:!0,bubbles:!0,detail:t})),!this.value||!i)return;const a=new f.CustomEvent(R.MEDIA_SHOW_SUBTITLES_REQUEST,{composed:!0,bubbles:!0,detail:this.value});this.dispatchEvent(a)};Av.getTemplateHTML=Ty;const Eh=(t,e)=>{const i=t.getAttribute(e);return i?wo(i):[]},_h=(t,e,i)=>{if(!i?.length){t.removeAttribute(e);return}const a=Jr(i);t.getAttribute(e)!==a&&t.setAttribute(e,a)};f.customElements.get("media-captions-menu")||f.customElements.define("media-captions-menu",Av);const Ay=`<svg aria-hidden="true" viewBox="0 0 26 24">
  <path d="M22.83 5.68a2.58 2.58 0 0 0-2.3-2.5c-3.62-.24-11.44-.24-15.06 0a2.58 2.58 0 0 0-2.3 2.5c-.23 4.21-.23 8.43 0 12.64a2.58 2.58 0 0 0 2.3 2.5c3.62.24 11.44.24 15.06 0a2.58 2.58 0 0 0 2.3-2.5c.23-4.21.23-8.43 0-12.64Zm-11.39 9.45a3.07 3.07 0 0 1-1.91.57 3.06 3.06 0 0 1-2.34-1 3.75 3.75 0 0 1-.92-2.67 3.92 3.92 0 0 1 .92-2.77 3.18 3.18 0 0 1 2.43-1 2.94 2.94 0 0 1 2.13.78c.364.359.62.813.74 1.31l-1.43.35a1.49 1.49 0 0 0-1.51-1.17 1.61 1.61 0 0 0-1.29.58 2.79 2.79 0 0 0-.5 1.89 3 3 0 0 0 .49 1.93 1.61 1.61 0 0 0 1.27.58 1.48 1.48 0 0 0 1-.37 2.1 2.1 0 0 0 .59-1.14l1.4.44a3.23 3.23 0 0 1-1.07 1.69Zm7.22 0a3.07 3.07 0 0 1-1.91.57 3.06 3.06 0 0 1-2.34-1 3.75 3.75 0 0 1-.92-2.67 3.88 3.88 0 0 1 .93-2.77 3.14 3.14 0 0 1 2.42-1 3 3 0 0 1 2.16.82 2.8 2.8 0 0 1 .73 1.31l-1.43.35a1.49 1.49 0 0 0-1.51-1.21 1.61 1.61 0 0 0-1.29.58A2.79 2.79 0 0 0 15 12a3 3 0 0 0 .49 1.93 1.61 1.61 0 0 0 1.27.58 1.44 1.44 0 0 0 1-.37 2.1 2.1 0 0 0 .6-1.15l1.4.44a3.17 3.17 0 0 1-1.1 1.7Z"/>
  ...
  `}function xy(){return C("Quality")}class Hu extends Ja{static get observedAttributes(){return[...super.observedAttributes,u.MEDIA_RENDITION_SELECTED,u.MEDIA_RENDITION_UNAVAILABLE,u.MEDIA_HEIGHT]}connectedCallback(){super.connectedCallback(),this.setAttribute("aria-label",C("quality"))}get invokeTargetElement(){return this.invokeTarget!=null?super.invokeTargetElement:Ue(this).querySelector("media-rendition-menu")}get mediaRenditionSelected(){return ae(this,u.MEDIA_RENDITION_SELECTED)}set mediaRenditionSelected(e){re(this,u.MEDIA_RENDITION_SELECTED,e)}get mediaHeight(){return ie(this,u.MEDIA_HEIGHT)}set mediaHeight(e){de(this,u.MEDIA_HEIGHT,e)}}Hu.getSlotTemplateHTML=My;Hu.getTooltipContentHTML=xy;f.customElements.get("media-rendition-menu-button")||f.customElements.define("media-rendition-menu-button",Hu);var Bu=(t,e,i)=>{if(!e.has(t))throw TypeError("Cannot "+i)},Pt=(t,e,i)=>(Bu(t,e,"read from private field"),i?i.call(t):e.get(t)),kt=(t,e,i)=>{if(e.has(t))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(t):e.set(t,i)},Sv=(t,e,i,a)=>(Bu(t,e,"write to private field"),e.set(t,i),i),at=(t,e,i)=>(Bu(t,e,"access private method"),i),Za,un,No,Bi,xa,Wu,wv,Ms,_d,xs,bd,Iv,po,vo,Os;function Oy(t){return`
    ...
    `}class Rv extends ot{constructor(){super(),kt(this,un),kt(this,Bi),kt(this,Wu),kt(this,Ms),kt(this,bd),kt(this,Za,!1),kt(this,xs,e=>{const i=e.target,a=i?.nodeName==="VIDEO",r=at(this,Ms,_d).call(this,i);(a||r)&&(Pt(this,Za)?at(this,Bi,xa).call(this):at(this,bd,Iv).call(this,e))}),kt(this,po,e=>{const i=e.target,a=this.contains(i),r=e.button===2,n=i?.nodeName==="VIDEO",s=at(this,Ms,_d).call(this,i);a||r&&(n||s)||at(this,Bi,xa).call(this)}),kt(this,vo,e=>{e.key==="Escape"&&at(this,Bi,xa).call(this)}),kt(this,Os,e=>{var i,a;const r=e.target;if((i=r.matches)!=null&&i.call(r,'button[invoke="copy"]')){const n=(a=r.closest("media-context-menu-item"))==null?void 0:a.querySelector('input[slot="copy"]');n&&navigator.clipboard.writeText(n.value)}at(this,Bi,xa).call(this)}),this.setAttribute("noautohide",""),at(this,un,No).call(this)}connectedCallback(){super.connectedCallback(),Ue(this).addEventListener("contextmenu",Pt(this,xs)),this.addEventListener("click",Pt(this,Os))}disconnectedCallback(){super.disconnectedCallback(),Ue(this).removeEventListener("contextmenu",Pt(this,xs)),this.removeEventListener("click",Pt(this,Os)),document.removeEventListener("mousedown",Pt(this,po)),document.removeEventListener("keydown",Pt(this,vo))}}Za=new WeakMap;un=new WeakSet;No=function(){this.hidden=!Pt(this,Za)};Bi=new WeakSet;xa=function(){Sv(this,Za,!1),at(this,un,No).call(this)};Wu=new WeakSet;wv=function(){document.querySelectorAll("media-context-menu").forEach(e=>{var i;e!==this&&at(i=e,Bi,xa).call(i)})};Ms=new WeakSet;_d=function(t){return t?t.hasAttribute("slot")&&t.getAttribute("slot")==="media"?!0:t.nodeName.includes("-")&&t.tagName.includes("-")?t.hasAttribute("src")||t.hasAttribute("poster")||t.hasAttribute("preload")||t.hasAttribute("playsinline"):!1:!1};xs=new WeakMap;bd=new WeakSet;Iv=function(t){t.preventDefault(),at(this,Wu,wv).call(this),Sv(this,Za,!0),this.style.position="fixed",this.style.left=`${t.clientX}px`,this.style.top=`${t.clientY}px`,at(this,un,No).call(this),document.addEventListener("mousedown",Pt(this,po),{once:!0}),document.addEventListener("keydown",Pt(this,vo),{once:!0})};po=new WeakMap;vo=new WeakMap;Os=new WeakMap;Rv.getTemplateHTML=Oy;f.customElements.get("media-context-menu")||f.customElements.define("media-context-menu",Rv);function Ny(t){return`
    ${Si.getTemplateHTML.call(this,t)}
    <style>
        ::slotted(*) {
...
`,mr=new WeakMap,eT=class Uv{constructor(e,i){this.element=e,this.type=i,this.element.addEventListener(this.type,this);let a=mr.get(this.element);a&&a.set(this.type,this)}set(e){if(typeof e=="function")this.handleEvent=e.bind(this.element);else if(typeof e=="object"&&typeof e.handleEvent=="function")this.handleEvent=e.handleEvent.bind(e);else{this.element.removeEventListener(this.type,this);let i=mr.get(this.element);i&&i.delete(this.type)}}static for(e){mr.has(e.element)||mr.set(e.element,new Map);let i=e.attributeName.slice(2),a=mr.get(e.element);return a&&a.has(i)?a.get(i):new Uv(e.element,i)}};function tT(t,e){return t instanceof bt&&t.attributeName.startsWith("on")?(eT.for(t).set(e),t.element.removeAttributeNS(t.attributeNamespace,t.attributeName),!0):!1}function iT(t,e){return e instanceof Hv&&t instanceof Xa?(e.renderInto(t),!0):!1}function aT(t,e){return e instanceof DocumentFragment&&t instanceof Xa?(e.childNodes.length&&t.replace(...e.childNodes),!0):!1}function rT(t,e){if(t instanceof bt){let i=t.attributeNamespace,a=t.element.getAttributeNS(i,t.attributeName);return String(e)!==a&&(t.value=String(e)),!0}return t.value=String(e),!0}function nT(t,e){if(t instanceof bt&&e instanceof Element){let i=t.element;return i[t.attributeName]!==e&&(t.element.removeAttributeNS(t.attributeNamespace,t.attributeName),i[t.attributeName]=e),!0}return!1}function sT(t,e){if(typeof e=="boolean"&&t instanceof bt){let i=t.attributeNamespace,a=t.element.hasAttributeNS(i,t.attributeName);return e!==a&&(t.booleanValue=e),!0}return!1}function oT(t,e){return e===!1&&t instanceof Xa?(t.replace(""),!0):!1}function lT(t,e){nT(t,e)||sT(t,e)||tT(t,e)||oT(t,e)||iT(t,e)||aT(t,e)||rT(t,e)}var sl=new Map,wh=new WeakMap,Ih=new WeakMap,Hv=class{constructor(e,i,a){this.strings=e,this.values=i,this.processor=a,this.stringsKey=this.strings.join("")}get template(){if(sl.has(this.stringsKey))return sl.get(this.stringsKey);{let e=fo.createElement("template"),i=this.strings.length-1;return e.innerHTML=this.strings.reduce((a,r,n)=>a+r+(n<i?`{{ ${n} }}`:""),""),sl.set(this.stringsKey,e),e}}renderInto(e){var i;let a=this.template;if(wh.get(e)!==a){wh.set(e,a);let n=new Mo(a,this.values,this.processor);Ih.set(e,n),e instanceof Xa?e.replace(...n.children):e.appendChild(n);return}let r=Ih.get(e);(i=r?.update)==null||i.call(r,this.values)}},dT={processCallback(t,e,i){var a;if(i){for(let[r,n]of e)if(r in i){let s=(a=i[r])!=null?a:"";lT(n,s)}}}};function Ps(t,...e){return new Hv(t,e,dT)}function uT(t,e){t.renderInto(e)}var cT=t=>{let{tokens:e}=t;return e.drm?":host(:not([cast-receiver])) { --_cast-button-drm-display: none; }":""},hT=t=>Ps`
  <style>
    ${cT(t)}
    ${Jy}
  </style>
  ${fT(t)}
`,mT=t=>{let e=t.hotKeys?`${t.hotKeys}`:"";return qu(t.streamType)==="live"&&(e+=" noarrowleft noarrowright"),e},pT={TOP:"top",CENTER:"center",BOTTOM:"bottom",LAYER:"layer",MEDIA_LAYER:"media-layer",POSTER_LAYER:"poster-layer",VERTICAL_LAYER:"vertical-layer",CENTERED_LAYER:"centered-layer",GESTURE_LAYER:"gesture-layer",CONTROLLER_LAYER:"controller",BUTTON:"button",RANGE:"range",DISPLAY:"display",CONTROL_BAR:"control-bar",MENU_BUTTON:"menu-button",MENU:"menu",OPTION:"option",POSTER:"poster",LIVE:"live",PLAY:"play",PRE_PLAY:"pre-play",SEEK_BACKWARD:"seek-backward",SEEK_FORWARD:"seek-forward",MUTE:"mute",CAPTIONS:"captions",AIRPLAY:"airplay",PIP:"pip",FULLSCREEN:"fullscreen",CAST:"cast",PLAYBACK_RATE:"playback-rate",VOLUME:"volume",TIME:"time",TITLE:"title",AUDIO_TRACK:"audio-track",RENDITION:"rendition"},vT=Object.values(pT).join(", "),fT=t=>{var e,i,a,r,n,s,o,l,d,m,p,h,c,v,g,_,y,T,E,k,D,O,H,Y,X,V,P,Le,Be,We,he,Oe,yt,Ne,lt,Fe,Ae;return Ps`
  <media-theme
    ...
    style="${(r=By({"--media-primary-color":t.primaryColor,"--media-secondary-color":t.secondaryColor,"--media-accent-color":t.accentColor}))!=null?r:!1}"
...
`,yd=fo.createElement("template");"innerHTML"in yd&&(yd.innerHTML=yT);var Ch,Dh,Wv=class extends xo{};Wv.template=(Dh=(Ch=yd.content)==null?void 0:Ch.children)==null?void 0:Dh[0];Ut.customElements.get("media-theme-gerwig")||Ut.customElements.define("media-theme-gerwig",Wv);var TT="gerwig",Zt={SRC:"src",POSTER:"poster"},A={STYLE:"style",DEFAULT_HIDDEN_CAPTIONS:"default-hidden-captions",PRIMARY_COLOR:"primary-color",SECONDARY_COLOR:"secondary-color",ACCENT_COLOR:"accent-color",FORWARD_SEEK_OFFSET:"forward-seek-offset",BACKWARD_SEEK_OFFSET:"backward-seek-offset",PLAYBACK_TOKEN:"playback-token",THUMBNAIL_TOKEN:"thumbnail-token",STORYBOARD_TOKEN:"storyboard-token",FULLSCREEN_ELEMENT:"fullscreen-element",DRM_TOKEN:"drm-token",STORYBOARD_SRC:"storyboard-src",THUMBNAIL_TIME:"thumbnail-time",AUDIO:"audio",NOHOTKEYS:"nohotkeys",HOTKEYS:"hotkeys",PLAYBACK_RATES:"playbackrates",DEFAULT_SHOW_REMAINING_TIME:"default-show-remaining-time",DEFAULT_DURATION:"default-duration",TITLE:"title",VIDEO_TITLE:"video-title",PLACEHOLDER:"placeholder",THEME:"theme",DEFAULT_STREAM_TYPE:"default-stream-type",TARGET_LIVE_WINDOW:"target-live-window",EXTRA_SOURCE_PARAMS:"extra-source-params",NO_VOLUME_PREF:"no-volume-pref",NO_MUTED_PREF:"no-muted-pref",CAST_RECEIVER:"cast-receiver",NO_TOOLTIPS:"no-tooltips",PROUDLY_DISPLAY_MUX_BADGE:"proudly-display-mux-badge",DISABLE_PSEUDO_ENDED:"disable-pseudo-ended"},Td=["audio","backwardseekoffset","defaultduration","defaultshowremainingtime","defaultsubtitles","noautoseektolive","disabled","exportparts","forwardseekoffset","hideduration","hotkeys","nohotkeys","playbackrates","defaultstreamtype","streamtype","style","targetlivewindow","template","title","videotitle","novolumepref","nomutedpref","proudlydisplaymuxbadge"];function AT(t,e){var i,a;return{src:!t.playbackId&&t.src,playbackId:t.playbackId,hasSrc:!!t.playbackId||!!t.src||!!t.currentSrc,poster:t.poster,storyboard:t.storyboard,storyboardSrc:t.getAttribute(A.STORYBOARD_SRC),fullscreenElement:t.getAttribute(A.FULLSCREEN_ELEMENT),placeholder:t.getAttribute("placeholder"),themeTemplate:ST(t),thumbnailTime:!t.tokens.thumbnail&&t.thumbnailTime,autoplay:t.autoplay,crossOrigin:t.crossOrigin,loop:t.loop,noHotKeys:t.hasAttribute(A.NOHOTKEYS),hotKeys:t.getAttribute(A.HOTKEYS),muted:t.muted,paused:t.paused,preload:t.preload,envKey:t.envKey,preferCmcd:t.preferCmcd,debug:t.debug,disableTracking:t.disableTracking,disableCookies:t.disableCookies,tokens:t.tokens,beaconCollectionDomain:t.beaconCollectionDomain,maxResolution:t.maxResolution,minResolution:t.minResolution,programStartTime:t.programStartTime,programEndTime:t.programEndTime,assetStartTime:t.assetStartTime,assetEndTime:t.assetEndTime,renditionOrder:t.renditionOrder,metadata:t.metadata,playerInitTime:t.playerInitTime,playerSoftwareName:t.playerSoftwareName,playerSoftwareVersion:t.playerSoftwareVersion,startTime:t.startTime,preferPlayback:t.preferPlayback,audio:t.audio,defaultStreamType:t.defaultStreamType,targetLiveWindow:t.getAttribute(b.TARGET_LIVE_WINDOW),streamType:qu(t.getAttribute(b.STREAM_TYPE)),primaryColor:t.getAttribute(A.PRIMARY_COLOR),secondaryColor:t.getAttribute(A.SECONDARY_COLOR),accentColor:t.getAttribute(A.ACCENT_COLOR),forwardSeekOffset:t.forwardSeekOffset,backwardSeekOffset:t.backwardSeekOffset,defaultHiddenCaptions:t.defaultHiddenCaptions,defaultDuration:t.defaultDuration,defaultShowRemainingTime:t.defaultShowRemainingTime,hideDuration:wT(t),playbackRates:t.getAttribute(A.PLAYBACK_RATES),customDomain:(i=t.getAttribute(b.CUSTOM_DOMAIN))!=null?i:void 0,title:t.getAttribute(A.TITLE),videoTitle:(a=t.getAttribute(A.VIDEO_TITLE))!=null?a:t.getAttribute(A.TITLE),novolumepref:t.hasAttribute(A.NO_VOLUME_PREF),nomutedpref:t.hasAttribute(A.NO_MUTED_PREF),proudlyDisplayMuxBadge:t.hasAttribute(A.PROUDLY_DISPLAY_MUX_BADGE),castReceiver:t.castReceiver,disablePseudoEnded:t.hasAttribute(A.DISABLE_PSEUDO_ENDED),...e,extraSourceParams:t.extraSourceParams}}var kT=Op.formatErrorMessage;Op.formatErrorMessage=t=>{var e,i;if(t instanceof I){let a=bT(t,!1);return`
